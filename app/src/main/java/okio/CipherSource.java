...
public final class CipherSource implements Source {
    ...
    public CipherSource(@xi.k BufferedSource source, @xi.k Cipher cipher) {
    ...
    public long read(@xi.k Buffer sink, long byteCount) throws IOException {
