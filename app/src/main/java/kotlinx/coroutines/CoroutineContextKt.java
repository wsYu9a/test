...
public final class CoroutineContextKt {
    ...
    private static final CoroutineContext foldCopies(CoroutineContext coroutineContext, CoroutineContext coroutineContext2, boolean z10) {
        ...
        CoroutineContext coroutineContext3 = (CoroutineContext) coroutineContext.fold(emptyCoroutineContext, new Function2<CoroutineContext, CoroutineContext.Element, CoroutineContext>() { // from class: kotlinx.coroutines.CoroutineContextKt$foldCopies$folded$1
            ...
            public CoroutineContextKt$foldCopies$folded$1(Ref.ObjectRef<CoroutineContext> objectRef2, boolean z102) {
                super(2);
            ...
            @k
            public final CoroutineContext invoke(@k CoroutineContext coroutineContext4, @k CoroutineContext.Element element) {
        ...
        if (hasCopyableElements2) {
            objectRef2.element = ((CoroutineContext) objectRef2.element).fold(emptyCoroutineContext, CoroutineContextKt$foldCopies$1.INSTANCE);
        }
        return coroutineContext3.plus((CoroutineContext) objectRef2.element);
    }

    @l
    public static final String getCoroutineName(@k CoroutineContext coroutineContext) {
        return null;
    }
    ...
    public static final CoroutineContext newCoroutineContext(@k CoroutineScope coroutineScope, @k CoroutineContext coroutineContext) {
    ...
    @l
    public static final UndispatchedCoroutine<?> undispatchedCompletion(@k CoroutineStackFrame coroutineStackFrame) {
    ...
    @l
    public static final UndispatchedCoroutine<?> updateUndispatchedCompletion(@k Continuation<?> continuation, @k CoroutineContext coroutineContext, @l Object obj) {
    ...
    public static final <T> T withContinuationContext(@k Continuation<?> continuation, @l Object obj, @k Function0<? extends T> function0) {
    ...
    public static final <T> T withCoroutineContext(@k CoroutineContext coroutineContext, @l Object obj, @k Function0<? extends T> function0) {
    ...
    @k
    public static final CoroutineContext newCoroutineContext(@k CoroutineContext coroutineContext, @k CoroutineContext coroutineContext2) {
