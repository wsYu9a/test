...
public interface SelectBuilder<R> {
    ...
    public static final class DefaultImpls {
        ...
        public static <R, P, Q> void invoke(@k SelectBuilder<? super R> selectBuilder, @k SelectClause2<? super P, ? extends Q> selectClause2, @k Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        ...
        public static <R> void onTimeout(@k SelectBuilder<? super R> selectBuilder, long j10, @k Function1<? super Continuation<? super R>, ? extends Object> function1) {
            OnTimeoutKt.onTimeout(selectBuilder, j10, function1);
        }
    }

    void invoke(@k SelectClause0 selectClause0, @k Function1<? super Continuation<? super R>, ? extends Object> function1);

    <Q> void invoke(@k SelectClause1<? extends Q> selectClause1, @k Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2);

    <P, Q> void invoke(@k SelectClause2<? super P, ? extends Q> selectClause2, P p10, @k Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2);

    <P, Q> void invoke(@k SelectClause2<? super P, ? extends Q> selectClause2, @k Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Replaced with the same extension function", replaceWith = @ReplaceWith(expression = "onTimeout", imports = {"kotlinx.coroutines.selects.onTimeout"}))
    @LowPriorityInOverloadResolution
    @ExperimentalCoroutinesApi
    void onTimeout(long timeMillis, @k Function1<? super Continuation<? super R>, ? extends Object> r32);
}
