...
final class OnTimeout {
    ...
    public final void register(SelectInstance<?> select, Object ignoredParam) {
        ...
        OnTimeout$register$$inlined$Runnable$1 onTimeout$register$$inlined$Runnable$1 = new Runnable() { // from class: kotlinx.coroutines.selects.OnTimeout$register$$inlined$Runnable$1
            final /* synthetic */ OnTimeout this$0;

            public OnTimeout$register$$inlined$Runnable$1(OnTimeout this) {
                this = this;
            }
        ...
        select.disposeOnCompletion(DelayKt.getDelay(context).invokeOnTimeout(this.timeMillis, onTimeout$register$$inlined$Runnable$1, context));
    }
