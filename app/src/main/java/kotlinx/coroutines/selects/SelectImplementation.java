...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    public final class ClauseData {
        ...
        public ClauseData(@k Object obj, @k Function3<Object, ? super SelectInstance<?>, Object, Unit> function3, @k Function3<Object, Object, Object, ? extends Object> function32, @l Object obj2, @k Object obj3, @l Function3<? super SelectInstance<?>, Object, Object, ? extends Function1<? super Throwable, Unit>> function33) {
        ...
        @l
        public final Function1<Throwable, Unit> createOnCancellationAction(@k SelectInstance<?> select, @l Object internalResult) {
        ...
        @l
        public final Object invokeBlock(@l Object obj, @k Continuation<? super R> continuation) {
        ...
        @l
        public final Object processResult(@l Object r42) {
            return this.processResFunc.invoke(this.clauseObject, this.param, r42);
        }

        public final boolean tryRegisterAsWaiter(@k SelectImplementation<R> select) {
            Symbol symbol;
  ...
  0x0057: PHI (r6v5 java.lang.Object) = (r6v4 java.lang.Object), (r6v1 java.lang.Object) binds: [B:17:0x0054, B:10:0x0028] A[DONT_GENERATE, DONT_INLINE], RETURN] */
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x006a, code lost:
        ...
        if (r0 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L98;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0073, code lost:
        ...
        if (r0 != kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()) goto L101;
     */
    ...
    */
    ...
    public void onTimeout(long j10, @k Function1<? super Continuation<? super R>, ? extends Object> function1) {
        SelectBuilder.DefaultImpls.onTimeout(this, j10, function1);
    }

    @JvmName(name = "register")
    public final void register(@k SelectImplementation<R>.ClauseData clauseData, boolean z10) {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = state$FU;
    ...
    @Override // kotlinx.coroutines.selects.SelectInstance
    public boolean trySelect(@k Object clauseObject, @l Object r22) {
        return trySelectInternal(clauseObject, r22) == 0;
    }

    @k
    public final TrySelectDetailedResult trySelectDetailed(@k Object clauseObject, @l Object r22) {
        TrySelectDetailedResult TrySelectDetailedResult;
        TrySelectDetailedResult = SelectKt.TrySelectDetailedResult(trySelectInternal(clauseObject, r22));
        return TrySelectDetailedResult;
    }

    @Override // kotlinx.coroutines.selects.SelectBuilder
    public <P, Q> void invoke(@k SelectClause2<? super P, ? extends Q> selectClause2, @k Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
