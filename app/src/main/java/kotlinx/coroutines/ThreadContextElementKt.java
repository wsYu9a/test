...
public final class ThreadContextElementKt {
    @k
    public static final <T> ThreadContextElement<T> asContextElement(@k ThreadLocal<T> threadLocal, T t10) {
    ...
    @l
    public static final Object ensurePresent(@k ThreadLocal<?> threadLocal, @k Continuation<? super Unit> continuation) {
    ...
    @l
    public static final Object isPresent(@k ThreadLocal<?> threadLocal, @k Continuation<? super Boolean> continuation) {
