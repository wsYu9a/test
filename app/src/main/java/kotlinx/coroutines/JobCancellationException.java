...
public final class JobCancellationException extends CancellationException implements CopyableThrowable<JobCancellationException> {
    ...
    public JobCancellationException(@k String str, @l Throwable th2, @k Job job) {
        super(str);
        this.job = job;
        if (th2 != null) {
            initCause(th2);
    ...
    public boolean equals(@l Object r32) {
        if (r32 != this) {
            if (r32 instanceof JobCancellationException) {
                JobCancellationException jobCancellationException = (JobCancellationException) r32;
