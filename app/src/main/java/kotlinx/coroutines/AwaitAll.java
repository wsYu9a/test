...
final class AwaitAll<T> {
    ...
    public final class AwaitAllNode extends JobNode {
        ...
        public AwaitAllNode(@k CancellableContinuation<? super List<? extends T>> cancellableContinuation) {
        ...
        public final void setDisposer(@l AwaitAll<T>.DisposeHandlersOnCancel disposeHandlersOnCancel) {
            _disposer$FU.set(this, disposeHandlersOnCancel);
        }

        public final void setHandle(@k DisposableHandle disposableHandle) {
        ...
        public void invoke2(@l Throwable cause) {
            ...
            if (AwaitAll.notCompletedCount$FU.decrementAndGet(AwaitAll.this) == 0) {
                ...
                cancellableContinuation.resumeWith(Result.m58constructorimpl(arrayList));
            }
        }
    }
    ...
    public final class DisposeHandlersOnCancel extends CancelHandler {
        ...
        public DisposeHandlersOnCancel(@k AwaitAll<T>.AwaitAllNode[] awaitAllNodeArr) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public AwaitAll(@k Deferred<? extends T>[] deferredArr) {
        this.deferreds = deferredArr;
        this.notCompletedCount = deferredArr.length;
    }

    @l
    public final Object await(@k Continuation<? super List<? extends T>> continuation) {
