...
public final class InterruptibleKt {
    ...
    @l
    public static final <T> Object runInterruptible(@k CoroutineContext coroutineContext, @k Function0<? extends T> function0, @k Continuation<? super T> continuation) {
