...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final int createNewWorker() {
        synchronized (this.workers) {
            try {
                ...
                int coerceAtLeast = RangesKt.coerceAtLeast(i10 - ((int) ((j10 & BLOCKING_MASK) >> 21)), 0);
    ...
    @k
    public final Task createTask(@k Runnable r42, @k TaskContext taskContext) {
        long nanoTime = TasksKt.schedulerTimeSource.nanoTime();
        if (!(r42 instanceof Task)) {
            return new TaskImpl(r42, nanoTime, taskContext);
        }
        Task task = (Task) r42;
    ...
    public final void dispatch(@k Runnable r62, @k TaskContext taskContext, boolean tailDispatch) {
        AbstractTimeSource timeSource = AbstractTimeSourceKt.getTimeSource();
        if (timeSource != null) {
            timeSource.trackTask();
        }
        Task createTask = createTask(r62, taskContext);
        boolean z10 = false;
        boolean z11 = createTask.taskContext.getTaskMode() == 1;
        long addAndGet = z11 ? controlState$FU.addAndGet(this, 2097152L) : 0L;
    ...
    public void execute(@k Runnable r72) {
        dispatch$default(this, r72, null, false, 6, null);
    }
    ...
    public final boolean parkedWorkersStackPush(@k Worker worker) {
        long j10;
        long j11;
        int indexInArray;
    ...
    public final void parkedWorkersStackTopUpdate(@k Worker worker, int oldIndex, int newIndex) {
        AtomicLongFieldUpdater atomicLongFieldUpdater = parkedWorkersStack$FU;
        while (true) {
            long j10 = atomicLongFieldUpdater.get(this);
            ...
            long j11 = (2097152 + j10) & PARKED_VERSION_MASK;
            if (i10 == oldIndex) {
                i10 = newIndex == 0 ? parkedWorkersStackNextIndex(worker) : newIndex;
            }
            if (i10 >= 0 && parkedWorkersStack$FU.compareAndSet(this, j10, j11 | i10)) {
                return;
            }
        }
    }

    public final void runSafely(@k Task task) {
        try {
            task.run();
        } catch (Throwable th2) {
            try {
    ...
    public final class Worker extends Thread {
        ...
        private final boolean tryAcquireCpuPermit() {
            ...
            } while (!CoroutineScheduler.controlState$FU.compareAndSet(coroutineScheduler, j10, j10 - 4398046511104L));
        ...
        public final void setNextParkedWorker(@l Object obj) {
            this.nextParkedWorker = obj;
        }

        public final boolean tryReleaseCpu(@k WorkerState newState) {
