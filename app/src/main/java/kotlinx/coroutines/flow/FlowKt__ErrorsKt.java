...
final /* synthetic */ class FlowKt__ErrorsKt {
    @k
    /* renamed from: catch */
    public static final <T> Flow<T> m1597catch(@k Flow<? extends T> flow, @k Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
    ...
    */
    public static final <T> java.lang.Object catchImpl(@xi.k kotlinx.coroutines.flow.Flow<? extends T> r4, @xi.k kotlinx.coroutines.flow.FlowCollector<? super T> r5, @xi.k kotlin.coroutines.Continuation<? super java.lang.Throwable> r6) {
        /*
    ...
    public static final <T> Flow<T> retry(@k Flow<? extends T> flow, long j10, @k Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        if (j10 > 0) {
            return FlowKt.retryWhen(flow, new FlowKt__ErrorsKt$retry$3(j10, function2, null));
        }
        throw new IllegalArgumentException(("Expected positive amount of retries, but had " + j10).toString());
    }

    public static /* synthetic */ Flow retry$default(Flow flow, long j10, Function2 function2, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = Long.MAX_VALUE;
        }
        if ((i10 & 2) != 0) {
        ...
        return FlowKt.retry(flow, j10, function2);
    }
