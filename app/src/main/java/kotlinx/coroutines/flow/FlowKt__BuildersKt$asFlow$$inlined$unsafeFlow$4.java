...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", f = "Builders.kt", i = {0}, l = {TTDownloadField.CALL_DOWNLOAD_MODEL_SHOULD_DOWNLOAD_WITH_PATCH_APPLY}, m = "collect", n = {"$this$asFlow_u24lambda_u245"}, s = {"L$0"})
    ...
    */
    public java.lang.Object collect(@xi.k kotlinx.coroutines.flow.FlowCollector<? super T> r6, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
