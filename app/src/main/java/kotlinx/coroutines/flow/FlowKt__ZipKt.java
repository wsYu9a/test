...
final /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final <T1, T2, R> Flow<R> flowCombine(@k Flow<? extends T1> flow, @k Flow<? extends T2> flow2, @k Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$1
            ...
            public FlowKt__ZipKt$combine$$inlined$unsafeFlow$1(Flow flow22, Function3 function32) {
                flow2 = flow22;
    ...
    public static final <T1, T2, T3, R> Flow<R> combine(@k Flow<? extends T1> flow, @k Flow<? extends T2> flow2, @k Flow<? extends T3> flow3, @k @BuilderInference Function4<? super T1, ? super T2, ? super T3, ? super Continuation<? super R>, ? extends Object> function4) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            ...
            public FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1(Flow[] flowArr, Function4 function42) {
                flowArr = flowArr;
            ...
            public Object collect(@k FlowCollector flowCollector, @k Continuation continuation) {
                Function0 function0;
                Flow[] flowArr = flowArr;
                function0 = FlowKt__ZipKt$nullArrayFactory$1.INSTANCE;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null, function4), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
        };
    }
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combine(@k Flow<? extends T1> flow, @k Flow<? extends T2> flow2, @k Flow<? extends T3> flow3, @k Flow<? extends T4> flow4, @k Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super R>, ? extends Object> function5) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            ...
            public FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2(Flow[] flowArr, Function5 function52) {
                flowArr = flowArr;
            ...
            public Object collect(@k FlowCollector flowCollector, @k Continuation continuation) {
                ...
                Flow[] flowArr = flowArr;
                function0 = FlowKt__ZipKt$nullArrayFactory$1.INSTANCE;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null, function5), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
        };
    }
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combine(@k Flow<? extends T1> flow, @k Flow<? extends T2> flow2, @k Flow<? extends T3> flow3, @k Flow<? extends T4> flow4, @k Flow<? extends T5> flow5, @k Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super R>, ? extends Object> function6) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            ...
            public FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3(Flow[] flowArr, Function6 function62) {
                flowArr = flowArr;
            ...
            public Object collect(@k FlowCollector flowCollector, @k Continuation continuation) {
                ...
                Flow[] flowArr = flowArr;
                function0 = FlowKt__ZipKt$nullArrayFactory$1.INSTANCE;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null, function6), continuation);
                return combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? combineInternal : Unit.INSTANCE;
            }
        };
    }
