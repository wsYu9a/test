...
public final class LintKt {
    ...
    public static final void cancel(@k FlowCollector<?> flowCollector, @l CancellationException cancellationException) {
        FlowKt.noImpl();
    ...
    @k
    public static final <T> Flow<T> cancellable(@k SharedFlow<? extends T> sharedFlow) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    @InlineOnly
    /* renamed from: catch */
    private static final <T> Flow<T> m1598catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        return FlowKt.m1586catch(sharedFlow, function3);
    }
    ...
    @k
    public static final <T> Flow<T> conflate(@k StateFlow<? extends T> stateFlow) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    @k
    public static final <T> Flow<T> distinctUntilChanged(@k StateFlow<? extends T> stateFlow) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    @k
    public static final <T> Flow<T> flowOn(@k SharedFlow<? extends T> sharedFlow, @k CoroutineContext coroutineContext) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }

    @k
    public static final CoroutineContext getCoroutineContext(@k FlowCollector<?> flowCollector) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    public static final boolean isActive(@k FlowCollector<?> flowCollector) {
        FlowKt.noImpl();
        throw new KotlinNothingValueException();
    }
    ...
    @InlineOnly
    private static final <T> Flow<T> retry(SharedFlow<? extends T> sharedFlow, long j10, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
