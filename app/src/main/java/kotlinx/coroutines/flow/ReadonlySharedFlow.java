...
final class ReadonlySharedFlow<T> implements SharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public ReadonlySharedFlow(@k SharedFlow<? extends T> sharedFlow, @l Job job) {
        this.job = job;
