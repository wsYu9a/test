...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    public static final <T, R> Flow<R> flatMapConcat(@k Flow<? extends T> flow, @k Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt.flattenConcat(new Flow<Flow<? extends R>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapConcat$$inlined$map$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                */
                public final java.lang.Object emit(java.lang.Object r7, @xi.k kotlin.coroutines.Continuation r8) {
                    /*
                        r6 = this;
            ...
            public FlowKt__MergeKt$flatMapConcat$$inlined$map$1(Function2 function22) {
    ...
    public static final <T, R> Flow<R> flatMapMerge(@k Flow<? extends T> flow, int i10, @k Function2<? super T, ? super Continuation<? super Flow<? extends R>>, ? extends Object> function2) {
        return FlowKt.flattenMerge(new Flow<Flow<? extends R>>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapMerge$$inlined$map$1
            ...
            public FlowKt__MergeKt$flatMapMerge$$inlined$map$1(Function2 function22) {
                function2 = function22;
            }
    ...
    public static final <T> Flow<T> flattenConcat(@k Flow<? extends Flow<? extends T>> flow) {
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1
            public FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1() {
            }
    ...
    public static final <T> Flow<T> flattenMerge(@k Flow<? extends Flow<? extends T>> flow, int i10) {
        if (i10 > 0) {
            return i10 == 1 ? FlowKt.flattenConcat(flow) : new ChannelFlowMerge(flow, i10, null, 0, null, 28, null);
        }
