...
public abstract class AbstractFlow<T> implements Flow<T>, CancellableFlow<T> {
    ...
    */
    public final java.lang.Object collect(@xi.k kotlinx.coroutines.flow.FlowCollector<? super T> r6, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r5 = this;
    ...
    @l
    public abstract Object collectSafely(@k FlowCollector<? super T> flowCollector, @k Continuation<? super Unit> continuation);
}
