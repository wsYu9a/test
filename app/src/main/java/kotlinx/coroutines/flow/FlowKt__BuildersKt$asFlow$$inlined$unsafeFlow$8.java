...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8 implements Flow<Long> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8", f = "Builders.kt", i = {0, 0}, l = {TTDownloadField.CALL_DOWNLOAD_MODEL_SHOULD_DOWNLOAD_WITH_PATCH_APPLY}, m = "collect", n = {"$this$asFlow_u24lambda_u2415", "$this$forEach$iv"}, s = {"L$0", "L$1"})
    ...
    */
    public java.lang.Object collect(@xi.k kotlinx.coroutines.flow.FlowCollector<? super java.lang.Long> r8, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r7 = this;
