...
class ChannelFlowBuilder<T> extends ChannelFlow<T> {
    ...
    public ChannelFlow<T> create(@k CoroutineContext r32, int capacity, @k BufferOverflow onBufferOverflow) {
        return new ChannelFlowBuilder(this.block, r32, capacity, onBufferOverflow);
    }
    ...
    public ChannelFlowBuilder(@k Function2<? super ProducerScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> function2, @k CoroutineContext coroutineContext, int i10, @k BufferOverflow bufferOverflow) {
