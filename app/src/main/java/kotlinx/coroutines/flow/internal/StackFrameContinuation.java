...
final class StackFrameContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public StackFrameContinuation(@k Continuation<? super T> continuation, @k CoroutineContext coroutineContext) {
