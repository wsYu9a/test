...
final class UndispatchedContextCollector<T> implements FlowCollector<T> {
    ...
    public UndispatchedContextCollector(@k FlowCollector<? super T> flowCollector, @k CoroutineContext coroutineContext) {
    ...
    public Object emit(T t10, @k Continuation<? super Unit> continuation) {
        Object withContextUndispatched = ChannelFlowKt.withContextUndispatched(this.emitContext, t10, this.countOrElement, this.emitRef, continuation);
