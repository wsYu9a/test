...
public final class CombineKt {
    ...
    @k
    public static final <T1, T2, R> Flow<R> zipImpl(@k Flow<? extends T1> flow, @k Flow<? extends T2> flow2, @k Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3) {
        return new Flow<R>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$$inlined$unsafeFlow$1
            final /* synthetic */ Flow $flow$inlined;
            final /* synthetic */ Function3 $transform$inlined;

            public CombineKt$zipImpl$$inlined$unsafeFlow$1(Flow flow3, Function3 function32) {
                flow = flow3;
