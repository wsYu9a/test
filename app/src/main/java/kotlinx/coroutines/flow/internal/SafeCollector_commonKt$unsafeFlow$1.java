...
public final class SafeCollector_commonKt$unsafeFlow$1<T> implements Flow<T> {
    ...
    @l
    public Object collect$$forInline(@k FlowCollector<? super T> flowCollector, @k Continuation<? super Unit> continuation) {
        InlineMarker.mark(4);
        new ContinuationImpl(continuation) { // from class: kotlinx.coroutines.flow.internal.SafeCollector_commonKt$unsafeFlow$1$collect$1
            ...
            public SafeCollector_commonKt$unsafeFlow$1$collect$1(Continuation<? super SafeCollector_commonKt$unsafeFlow$1$collect$1> continuation2) {
                super(continuation2);
            }
        ...
        InlineMarker.mark(5);
        this.$block.invoke(flowCollector, continuation2);
