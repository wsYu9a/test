...
final class ReadonlyStateFlow<T> implements StateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public ReadonlyStateFlow(@k StateFlow<? extends T> stateFlow, @l Job job) {
        this.job = job;
