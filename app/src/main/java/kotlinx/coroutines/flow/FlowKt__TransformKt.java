...
final /* synthetic */ class FlowKt__TransformKt {
    ...
    public static final <T> Flow<T> filterNotNull(@k Flow<? extends T> flow) {
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1
            ...
            public FlowKt__TransformKt$filterNotNull$$inlined$unsafeTransform$1() {
            }
    ...
    public static final <T> Flow<T> onEach(@k Flow<? extends T> flow, @k Function2<? super T, ? super Continuation<? super Unit>, ? extends Object> function2) {
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1
            ...
            public FlowKt__TransformKt$onEach$$inlined$unsafeTransform$1(Function2 function22) {
    ...
    public static final <T, R> Flow<R> runningFold(@k Flow<? extends T> flow, R r10, @k @BuilderInference Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return new FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1(r10, flow, function3);
    }
    ...
    public static final <T> Flow<T> runningReduce(@k Flow<? extends T> flow, @k Function3<? super T, ? super T, ? super Continuation<? super T>, ? extends Object> function3) {
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1
            ...
            public FlowKt__TransformKt$runningReduce$$inlined$unsafeFlow$1(Function3 function32) {
    ...
    public static final <T, R> Flow<R> scan(@k Flow<? extends T> flow, R r10, @k @BuilderInference Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return FlowKt.runningFold(flow, r10, function3);
    }
    ...
    public static final <T> Flow<IndexedValue<T>> withIndex(@k Flow<? extends T> flow) {
        return new Flow<IndexedValue<? extends T>>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$withIndex$$inlined$unsafeFlow$1
            public FlowKt__TransformKt$withIndex$$inlined$unsafeFlow$1() {
            }

            @Override // kotlinx.coroutines.flow.Flow
            @l
            public Object collect(@k FlowCollector<? super IndexedValue<? extends T>> flowCollector, @k Continuation<? super Unit> continuation) {
        ...
        return new Flow<Object>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filterIsInstance$$inlined$filter$2
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                /*
                    ...
                    To view partially-correct code enable 'Show inconsistent code' option in preferences
                */
                public final java.lang.Object emit(java.lang.Object r5, @xi.k kotlin.coroutines.Continuation r6) {
                    /*
                        r4 = this;
            ...
            public FlowKt__TransformKt$filterIsInstance$$inlined$filter$2(KClass kClass2) {
                kClass = kClass2;
            }
