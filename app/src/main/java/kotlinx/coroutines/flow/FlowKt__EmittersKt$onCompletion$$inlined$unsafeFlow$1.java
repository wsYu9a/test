...
public final class FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__EmittersKt$onCompletion$$inlined$unsafeFlow$1", f = "Emitters.kt", i = {0, 0, 1, 2}, l = {114, 121, 128}, m = "collect", n = {"this", "$this$onCompletion_u24lambda_u242", e.TAG, "sc"}, s = {"L$0", "L$1", "L$0", "L$0"})
    ...
    */
    public java.lang.Object collect(@xi.k kotlinx.coroutines.flow.FlowCollector<? super T> r9, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        /*
            r8 = this;
