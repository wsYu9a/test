...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7 implements Flow<Integer> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7", f = "Builders.kt", i = {0, 0}, l = {TTDownloadField.CALL_DOWNLOAD_MODEL_SHOULD_DOWNLOAD_WITH_PATCH_APPLY}, m = "collect", n = {"$this$asFlow_u24lambda_u2413", "$this$forEach$iv"}, s = {"L$0", "L$1"})
    ...
    */
    public java.lang.Object collect(@xi.k kotlinx.coroutines.flow.FlowCollector<? super java.lang.Integer> r7, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r6 = this;
