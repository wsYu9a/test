...
public final class FlowKt__LimitKt$collectWhile$collector$1<T> implements FlowCollector<T> {
    ...
    */
    public java.lang.Object emit(T r5, @xi.k kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
    ...
    public Object emit$$forInline(T t10, @k Continuation<? super Unit> continuation) {
        ...
        InlineMarker.mark(5);
        if (((Boolean) this.$predicate.invoke(t10, continuation)).booleanValue()) {
