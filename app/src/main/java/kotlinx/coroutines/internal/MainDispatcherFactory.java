...
public interface MainDispatcherFactory {
    ...
    public static final class DefaultImpls {
        @l
        public static String hintOnError(@k MainDispatcherFactory mainDispatcherFactory) {
            return null;
        }
    }

    @k
    MainCoroutineDispatcher createDispatcher(@k List<? extends MainDispatcherFactory> allFactories);
