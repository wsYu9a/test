...
public class ScopeCoroutine<T> extends AbstractCoroutine<T> implements CoroutineStackFrame {
    ...
    public ScopeCoroutine(@k CoroutineContext coroutineContext, @k Continuation<? super T> continuation) {
