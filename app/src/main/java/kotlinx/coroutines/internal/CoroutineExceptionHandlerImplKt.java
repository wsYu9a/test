...
public final class CoroutineExceptionHandlerImplKt {
    ...
    public static final void ensurePlatformExceptionHandlerLoaded(@k CoroutineExceptionHandler coroutineExceptionHandler) {
    ...
    public static final void propagateExceptionFinalResort(@k Throwable th2) {
