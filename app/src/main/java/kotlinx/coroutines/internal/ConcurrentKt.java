...
public final class ConcurrentKt {
    ...
    public static final boolean removeFutureOnCancel(@k Executor executor) {
        Method method;
        try {
    ...
    public static final <T> T withLock(@k ReentrantLock reentrantLock, @k Function0<? extends T> function0) {
        reentrantLock.lock();
        try {
