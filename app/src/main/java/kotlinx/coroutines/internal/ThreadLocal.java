...
public final class ThreadLocal<T> implements ThreadContextElement<T> {
    ...
    public ThreadLocal(T t10, @k java.lang.ThreadLocal<T> threadLocal) {
        this.value = t10;
    ...
    public CoroutineContext minusKey(@k CoroutineContext.Key<?> r22) {
        return Intrinsics.areEqual(getKey(), r22) ? EmptyCoroutineContext.INSTANCE : this;
    }
    ...
    public void restoreThreadContext(@k CoroutineContext r12, T oldState) {
    ...
    @Override // kotlinx.coroutines.ThreadContextElement
    public T updateThreadContext(@k CoroutineContext r32) {
