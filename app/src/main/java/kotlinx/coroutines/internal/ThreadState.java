...
final class ThreadState {
    ...
    public ThreadState(@k CoroutineContext coroutineContext, int i10) {
        this.context = coroutineContext;
        this.values = new Object[i10];
        this.elements = new ThreadContextElement[i10];
    }

    public final void append(@k ThreadContextElement<?> element, @l Object value) {
    ...
    public final void restore(@k CoroutineContext r52) {
        ...
        while (true) {
            ...
            threadContextElement.restoreThreadContext(r52, this.values[length]);
            if (i10 < 0) {
                return;
            } else {
                length = i10;
