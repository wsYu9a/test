...
public abstract class AbstractTimeSource {
    ...
    public abstract void parkNanos(@k Object blocker, long nanos);
    ...
    public abstract void unpark(@k Thread thread);

    public abstract void unregisterTimeLoopThread();

    @k
    public abstract Runnable wrapTask(@k Runnable r12);
}
