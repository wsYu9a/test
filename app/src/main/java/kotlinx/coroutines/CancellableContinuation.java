...
public interface CancellableContinuation<T> extends Continuation<T> {
    ...
    boolean cancel(@l Throwable cause);

    @InternalCoroutinesApi
    void completeResume(@k Object r12);

    @InternalCoroutinesApi
    void initCancellability();

    void invokeOnCancellation(@k Function1<? super Throwable, Unit> handler);
    ...
    void resume(T t10, @l Function1<? super Throwable, Unit> function1);

    @ExperimentalCoroutinesApi
    void resumeUndispatched(@k CoroutineDispatcher coroutineDispatcher, T t10);

    @ExperimentalCoroutinesApi
    void resumeUndispatchedWithException(@k CoroutineDispatcher coroutineDispatcher, @k Throwable th2);

    @InternalCoroutinesApi
    @l
    Object tryResume(T value, @l Object idempotent);

    @InternalCoroutinesApi
    @l
    Object tryResume(T value, @l Object idempotent, @l Function1<? super Throwable, Unit> onCancellation);

    @InternalCoroutinesApi
    @l
    Object tryResumeWithException(@k Throwable exception);
}
