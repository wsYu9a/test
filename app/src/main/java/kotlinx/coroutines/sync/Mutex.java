...
public interface Mutex {
    ...
    boolean holdsLock(@k Object owner);

    boolean isLocked();

    @l
    Object lock(@l Object obj, @k Continuation<? super Unit> continuation);

    boolean tryLock(@l Object owner);

    void unlock(@l Object obj);
}
