...
public final class TimeoutCancellationException extends CancellationException implements CopyableThrowable<TimeoutCancellationException> {
    ...
    public TimeoutCancellationException(@k String str, @l Job job) {
        super(str);
        this.coroutine = job;
    }
