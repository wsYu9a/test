...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public final class DelayedResumeTask extends DelayedTask {
        ...
        public DelayedResumeTask(long j10, @k CancellableContinuation<? super Unit> cancellableContinuation) {
            super(j10);
    ...
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0019\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\n\u0010\u0004\u001a\u00060\u0005j\u0002`\u0006¢\u0006\u0002\u0010\u0007J\b\u0010\b\u001a\u00020\tH\u0016J\b\u0010\n\u001a\u00020\u000bH\u0016R\u0012\u0010\u0004\u001a\u00060\u0005j\u0002`\u0006X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, d2 = {"Lkotlinx/coroutines/EventLoopImplBase$DelayedRunnableTask;", "Lkotlinx/coroutines/EventLoopImplBase$DelayedTask;", "nanoTime", "", e.f19025e, "Ljava/lang/Runnable;", "Lkotlinx/coroutines/Runnable;", "(JLjava/lang/Runnable;)V", "run", "", "toString", "", "kotlinx-coroutines-core"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class DelayedRunnableTask extends DelayedTask {

        @k
        private final Runnable block;

        public DelayedRunnableTask(long j10, @k Runnable runnable) {
            super(j10);
            this.block = runnable;
        }
    ...
    public static abstract class DelayedTask implements Runnable, Comparable<DelayedTask>, DisposableHandle, ThreadSafeHeapNode {
        ...
        public final int scheduleTask(long now, @k DelayedTaskQueue delayed, @k EventLoopImplBase eventLoop) {
            Symbol symbol;
            synchronized (this) {
                Object obj = this._heap;
                symbol = EventLoop_commonKt.DISPOSED_TASK;
        ...
        @Override // kotlinx.coroutines.internal.ThreadSafeHeapNode
        public void setHeap(@l ThreadSafeHeap<?> threadSafeHeap) {
            Symbol symbol;
            Object obj = this._heap;
            symbol = EventLoop_commonKt.DISPOSED_TASK;
            if (obj == symbol) {
        ...
        public int compareTo(@k DelayedTask r52) {
            long j10 = this.nanoTime - r52.nanoTime;
            if (j10 > 0) {
                return 1;
            }
            return j10 < 0 ? -1 : 0;
    ...
    public final void mo1612dispatch(@k CoroutineContext r12, @k Runnable r22) {
        enqueue(r22);
    }

    public void enqueue(@k Runnable task) {
        if (enqueueImpl(task)) {
            unpark();
        } else {
    ...
    public final void schedule(long now, @k DelayedTask delayedTask) {
    ...
    @k
    public final DisposableHandle scheduleInvokeOnTimeout(long timeMillis, @k Runnable r62) {
        ...
        AbstractTimeSource timeSource = AbstractTimeSourceKt.getTimeSource();
        long nanoTime = timeSource != null ? timeSource.nanoTime() : System.nanoTime();
        DelayedRunnableTask delayedRunnableTask = new DelayedRunnableTask(delayToNanos + nanoTime, r62);
