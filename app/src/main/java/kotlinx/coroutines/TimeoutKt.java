...
public final class TimeoutKt {
    ...
    */
    public static final kotlinx.coroutines.TimeoutCancellationException TimeoutCancellationException(long r2, @xi.k kotlinx.coroutines.Delay r4, @xi.k kotlinx.coroutines.Job r5) {
        /*
        ...
        L8:
            ...
            java.lang.String r4 = r4.m1548timeoutMessageLRDsOJo(r0)
            if (r4 != 0) goto L2e
        L18:
    ...
    @l
    public static final <T> Object withTimeout(long j10, @k Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @k Continuation<? super T> continuation) {
        if (j10 <= 0) {
    ...
    public static final <T> Object m1555withTimeoutKLykuaI(long j10, @k Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @k Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1547toDelayMillisLRDsOJo(j10), function2, continuation);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, @xi.k kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, @xi.k kotlin.coroutines.Continuation<? super T> r10) {
        /*
    ...
    public static final <T> Object m1556withTimeoutOrNullKLykuaI(long j10, @k Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, @k Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1547toDelayMillisLRDsOJo(j10), function2, continuation);
    }
}
