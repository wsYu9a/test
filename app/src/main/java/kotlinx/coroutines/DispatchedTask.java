...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void handleFatalException(@l Throwable exception, @l Throwable finallyException) {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                ...
                try {
                    ...
                    m58constructorimpl2 = Result.m58constructorimpl(unit);
                } catch (Throwable th2) {
            ...
            try {
                ...
                m58constructorimpl = Result.m58constructorimpl(ResultKt.createFailure(th5));
            }
            handleFatalException(th4, Result.m61exceptionOrNullimpl(m58constructorimpl));
        }
    }
