...
public final class CompletionHandlerKt {
    @k
    public static final Function1<Throwable, Unit> getAsHandler(@k CancelHandlerBase cancelHandlerBase) {
        return cancelHandlerBase;
    }

    public static final void invokeIt(@k Function1<? super Throwable, Unit> function1, @l Throwable th2) {
        function1.invoke(th2);
    }

    @k
    public static final Function1<Throwable, Unit> getAsHandler(@k CompletionHandlerBase completionHandlerBase) {
