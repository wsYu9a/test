...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@k SendChannel<? super E> sendChannel, E e10) {
            Object mo1557trySendJP2dKIU = sendChannel.mo1557trySendJP2dKIU(e10);
            if (ChannelResult.m1577isSuccessimpl(mo1557trySendJP2dKIU)) {
                return true;
            }
            Throwable m1571exceptionOrNullimpl = ChannelResult.m1571exceptionOrNullimpl(mo1557trySendJP2dKIU);
    ...
    boolean close(@l Throwable cause);

    @k
    SelectClause2<E, SendChannel<E>> getOnSend();

    void invokeOnClose(@k Function1<? super Throwable, Unit> handler);
    ...
    @l
    Object send(E e10, @k Continuation<? super Unit> continuation);

    @k
    /* renamed from: trySend-JP2dKIU */
    Object mo1557trySendJP2dKIU(E element);
}
