...
public interface Channel<E> extends SendChannel<E>, ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        @l
        public static <E> Object receiveOrNull(@k Channel<E> channel, @k Continuation<? super E> continuation) {
    ...
    public static final class Companion {
        ...
        private static final int CHANNEL_DEFAULT_CAPACITY = SystemPropsKt.systemProp("kotlinx.coroutines.channels.defaultBuffer", 64, 1, WrapperAdapter.f12831j);
