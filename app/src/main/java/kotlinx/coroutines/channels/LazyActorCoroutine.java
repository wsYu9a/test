...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> {
    ...
    public LazyActorCoroutine(@k CoroutineContext coroutineContext, @k Channel<E> channel, @k Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
