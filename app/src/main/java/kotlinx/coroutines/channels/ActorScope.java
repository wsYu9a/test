...
public interface ActorScope<E> extends CoroutineScope, ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        @k
        public static <E> SelectClause1<E> getOnReceiveOrNull(@k ActorScope<E> actorScope) {
        ...
        @l
        public static <E> E poll(@k ActorScope<E> actorScope) {
        ...
        @l
        public static <E> Object receiveOrNull(@k ActorScope<E> actorScope, @k Continuation<? super E> continuation) {
