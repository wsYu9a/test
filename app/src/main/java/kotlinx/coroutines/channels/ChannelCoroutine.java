...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public ChannelCoroutine(@k CoroutineContext coroutineContext, @k Channel<E> channel, boolean z10, boolean z11) {
    ...
    public void cancelInternal(@k Throwable cause) {
    ...
    public Object mo1561receiveCatchingJP2dKIU(@k Continuation<? super ChannelResult<? extends E>> continuation) {
        Object mo1561receiveCatchingJP2dKIU = this._channel.mo1561receiveCatchingJP2dKIU(continuation);
        IntrinsicsKt.getCOROUTINE_SUSPENDED();
        return mo1561receiveCatchingJP2dKIU;
    }
    ...
    public Object mo1562tryReceivePtdJZtk() {
        return this._channel.mo1562tryReceivePtdJZtk();
    }
    ...
    public Object mo1557trySendJP2dKIU(E element) {
        return this._channel.mo1557trySendJP2dKIU(element);
    }
