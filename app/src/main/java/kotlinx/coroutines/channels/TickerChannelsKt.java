...
public final class TickerChannelsKt {
    ...
    */
    ...
    @k
    public static final ReceiveChannel<Unit> ticker(long j10, long j11, @k CoroutineContext coroutineContext, @k TickerMode tickerMode) {
        if (j10 < 0) {
