...
final class LazyBroadcastCoroutine<E> extends BroadcastCoroutine<E> {
    ...
    public LazyBroadcastCoroutine(@k CoroutineContext coroutineContext, @k BroadcastChannel<E> broadcastChannel, @k Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
