...
public final class ExecutorsKt {
    ...
    @k
    public static final Executor asExecutor(@k CoroutineDispatcher coroutineDispatcher) {
        Executor executor;
    ...
    public static final ExecutorCoroutineDispatcher from(@k ExecutorService executorService) {
        return new ExecutorCoroutineDispatcherImpl(executorService);
    }

    @k
    @JvmName(name = TypedValues.TransitionType.S_FROM)
    public static final CoroutineDispatcher from(@k Executor executor) {
