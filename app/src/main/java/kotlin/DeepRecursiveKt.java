...
public final class DeepRecursiveKt {
    ...
    static {
        ...
        UNDEFINED_RESULT = Result.m58constructorimpl(IntrinsicsKt.getCOROUTINE_SUSPENDED());
    }

    @SinceKotlin(version = "1.7")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final <T, R> R invoke(@k DeepRecursiveFunction<T, R> deepRecursiveFunction, T t10) {
