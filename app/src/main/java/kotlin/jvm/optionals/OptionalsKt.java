...
public final class OptionalsKt {
    ...
    public static final <T> Sequence<T> asSequence(@k Optional<? extends T> optional) {
        boolean isPresent;
        Object obj;
    ...
    @SinceKotlin(version = "1.8")
    @WasExperimental(markerClass = {ExperimentalStdlibApi.class})
    public static final <T> T getOrElse(@k Optional<? extends T> optional, @k Function0<? extends T> defaultValue) {
        boolean isPresent;
        Object obj;
        Intrinsics.checkNotNullParameter(optional, "<this>");
