...
public final class EnumEntriesKt {
    ...
    @k
    @PublishedApi
    public static final <E extends Enum<E>> EnumEntries<E> enumEntries(@k Function0<E[]> entriesProvider) {
    ...
    @k
    @PublishedApi
    public static final <E extends Enum<E>> EnumEntries<E> enumEntries(@k E[] entries) {
