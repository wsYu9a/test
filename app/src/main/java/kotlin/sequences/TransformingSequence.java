...
public final class TransformingSequence<T, R> implements Sequence<R> {
    ...
    public TransformingSequence(@k Sequence<? extends T> sequence, @k Function1<? super T, ? extends R> transformer) {
    ...
    @k
    public final <E> Sequence<E> flatten$kotlin_stdlib(@k Function1<? super R, ? extends Iterator<? extends E>> iterator) {
