...
public class SequencesKt__SequenceBuilderKt {
    ...
    @k
    public static <T> Iterator<T> iterator(@k @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
    ...
    @SinceKotlin(version = "1.3")
    @k
    public static <T> Sequence<T> sequence(@k @BuilderInference Function2<? super SequenceScope<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new Sequence<T>() { // from class: kotlin.sequences.SequencesKt__SequenceBuilderKt$sequence$$inlined$Sequence$1
            public SequencesKt__SequenceBuilderKt$sequence$$inlined$Sequence$1() {
            }
