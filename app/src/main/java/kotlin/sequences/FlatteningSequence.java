...
public final class FlatteningSequence<T, R, E> implements Sequence<E> {
    ...
    public FlatteningSequence(@k Sequence<? extends T> sequence, @k Function1<? super T, ? extends R> transformer, @k Function1<? super R, ? extends Iterator<? extends E>> iterator) {
