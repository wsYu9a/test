...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    @k
    public static <T> Sequence<T> asSequence(@k Iterator<? extends T> it) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @k
    public static <T> Sequence<T> constrainOnce(@k Sequence<? extends T> sequence) {
    ...
    @k
    public static final <T, C, R> Sequence<R> flatMapIndexed(@k Sequence<? extends T> source, @k Function2<? super Integer, ? super T, ? extends C> transform, @k Function1<? super C, ? extends Iterator<? extends R>> iterator) {
    ...
    @k
    public static final <T> Sequence<T> flatten(@k Sequence<? extends Sequence<? extends T>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    public static final <T> Sequence<T> flattenSequenceOfIterable(@k Sequence<? extends Iterable<? extends T>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return flatten$SequencesKt__SequencesKt(sequence, SequencesKt__SequencesKt$flatten$2.INSTANCE);
    }

    @k
    public static final <T> Sequence<T> generateSequence(@k Function0<? extends T> nextFunction) {
        ...
        return SequencesKt.constrainOnce(new GeneratorSequence(nextFunction, new Function1<T, T>() { // from class: kotlin.sequences.SequencesKt__SequencesKt$generateSequence$1
            ...
            /* JADX WARN: Multi-variable type inference failed */
            public SequencesKt__SequencesKt$generateSequence$1(Function0<? extends T> nextFunction2) {
                super(1);
                nextFunction = nextFunction2;
            }

            @Override // kotlin.jvm.functions.Function1
            @l
            public final T invoke(@k T it) {
    ...
    @k
    public static final <T> Sequence<T> ifEmpty(@k Sequence<? extends T> sequence, @k Function0<? extends Sequence<? extends T>> defaultValue) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @k
    public static <T> Sequence<T> sequenceOf(@k T... elements) {
    ...
    @k
    public static final <T> Sequence<T> shuffled(@k Sequence<? extends T> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return shuffled(sequence, Random.INSTANCE);
    }

    @k
    public static final <T, R> Pair<List<T>, List<R>> unzip(@k Sequence<? extends Pair<? extends T, ? extends R>> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @k
    public static <T> Sequence<T> generateSequence(@l T t10, @k Function1<? super T, ? extends T> nextFunction) {
        Intrinsics.checkNotNullParameter(nextFunction, "nextFunction");
        return t10 == null ? EmptySequence.INSTANCE : new GeneratorSequence(new Function0<T>() { // from class: kotlin.sequences.SequencesKt__SequencesKt$generateSequence$2
            final /* synthetic */ T $seed;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public SequencesKt__SequencesKt$generateSequence$2(T t102) {
                super(0);
                t10 = t102;
            }
    ...
    @SinceKotlin(version = "1.4")
    @k
    public static final <T> Sequence<T> shuffled(@k Sequence<? extends T> sequence, @k Random random) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @k
    public static <T> Sequence<T> generateSequence(@k Function0<? extends T> seedFunction, @k Function1<? super T, ? extends T> nextFunction) {
