...
public abstract class SequenceScope<T> {
    @l
    public abstract Object yield(T t10, @k Continuation<? super Unit> continuation);

    @l
    public final Object yieldAll(@k Iterable<? extends T> iterable, @k Continuation<? super Unit> continuation) {
        Object yieldAll;
    ...
    @l
    public abstract Object yieldAll(@k Iterator<? extends T> it, @k Continuation<? super Unit> continuation);

    @l
    public final Object yieldAll(@k Sequence<? extends T> sequence, @k Continuation<? super Unit> continuation) {
