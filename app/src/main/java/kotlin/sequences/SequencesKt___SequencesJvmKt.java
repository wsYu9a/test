...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    @k
    public static final <R> Sequence<R> filterIsInstance(@k Sequence<?> sequence, @k Class<R> klass) {
        ...
        Sequence<R> filter = SequencesKt.filter(sequence, new Function1<Object, Boolean>() { // from class: kotlin.sequences.SequencesKt___SequencesJvmKt$filterIsInstance$1
            ...
            public SequencesKt___SequencesJvmKt$filterIsInstance$1(Class<R> klass2) {
                super(1);
                klass = klass2;
            }
    ...
    @k
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(@k Sequence<?> sequence, @k C destination, @k Class<R> klass) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    /* renamed from: max */
    public static final /* synthetic */ Double m1328max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1336maxOrNull((Sequence<Double>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min */
    public static final /* synthetic */ Double m1330min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1344minOrNull((Sequence<Double>) sequence);
    }
    ...
    @k
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@k Sequence<? extends T> sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max */
    public static final /* synthetic */ Float m1329max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1337maxOrNull((Sequence<Float>) sequence);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min */
    public static final /* synthetic */ Float m1331min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt___SequencesKt.m1345minOrNull((Sequence<Float>) sequence);
    }

    @k
    public static final <T> SortedSet<T> toSortedSet(@k Sequence<? extends T> sequence, @k Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
