...
final class MatcherMatchResult implements MatchResult {
    ...
    public MatcherMatchResult(@k Matcher matcher, @k CharSequence input) {
    ...
    public List<String> getGroupValues() {
        if (this.groupValues_ == null) {
            this.groupValues_ = new AbstractList<String>() { // from class: kotlin.text.MatcherMatchResult$groupValues$1
                public MatcherMatchResult$groupValues$1() {
                }
