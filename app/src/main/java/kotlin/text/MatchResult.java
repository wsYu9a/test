...
public interface MatchResult {
    ...
    public static final class DefaultImpls {
        @k
        public static Destructured getDestructured(@k MatchResult matchResult) {
    ...
    public static final class Destructured {
        ...
        public Destructured(@k MatchResult match) {
