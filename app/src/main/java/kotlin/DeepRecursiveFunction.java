...
public final class DeepRecursiveFunction<T, R> {
    ...
    public DeepRecursiveFunction(@k Function3<? super DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> block) {
