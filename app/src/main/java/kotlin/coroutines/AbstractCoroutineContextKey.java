...
public abstract class AbstractCoroutineContextKey<B extends CoroutineContext.Element, E extends B> implements CoroutineContext.Key<E> {
    ...
    public AbstractCoroutineContextKey(@k CoroutineContext.Key<B> baseKey, @k Function1<? super CoroutineContext.Element, ? extends E> safeCast) {
    ...
    public final boolean isSubKey$kotlin_stdlib(@k CoroutineContext.Key<?> r22) {
        Intrinsics.checkNotNullParameter(r22, "key");
        return r22 == this || this.topmostKey == r22;
    }
