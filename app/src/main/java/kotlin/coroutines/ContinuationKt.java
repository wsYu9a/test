...
public final class ContinuationKt {
    ...
    private static final <T> Continuation<T> Continuation(CoroutineContext context, Function1<? super Result<? extends T>, Unit> resumeWith) {
        ...
        return new Continuation<T>() { // from class: kotlin.coroutines.ContinuationKt$Continuation$1
            ...
            public ContinuationKt$Continuation$1(Function1<? super Result<? extends T>, Unit> resumeWith2) {
                resumeWith = resumeWith2;
            }
            ...
            public void resumeWith(@k Object r22) {
                resumeWith.invoke(Result.m57boximpl(r22));
            }
        };
    }
    ...
    @SinceKotlin(version = "1.3")
    @k
    public static final <T> Continuation<Unit> createCoroutine(@k Function1<? super Continuation<? super T>, ? extends Object> function1, @k Continuation<? super T> completion) {
    ...
    private static final <T> void resume(Continuation<? super T> continuation, T t10) {
        ...
        continuation.resumeWith(Result.m58constructorimpl(t10));
    }
    ...
    private static final <T> void resumeWithException(Continuation<? super T> continuation, Throwable exception) {
        ...
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m58constructorimpl(ResultKt.createFailure(exception)));
    }

    @SinceKotlin(version = "1.3")
    public static final <T> void startCoroutine(@k Function1<? super Continuation<? super T>, ? extends Object> function1, @k Continuation<? super T> completion) {
        Intrinsics.checkNotNullParameter(function1, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
    ...
    @SinceKotlin(version = "1.3")
    @k
    public static final <R, T> Continuation<Unit> createCoroutine(@k Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r10, @k Continuation<? super T> completion) {
    ...
    @SinceKotlin(version = "1.3")
    public static final <R, T> void startCoroutine(@k Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r10, @k Continuation<? super T> completion) {
        Intrinsics.checkNotNullParameter(function2, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
        Continuation intercepted = IntrinsicsKt.intercepted(IntrinsicsKt.createCoroutineUnintercepted(function2, r10, completion));
        Result.Companion companion = Result.INSTANCE;
        intercepted.resumeWith(Result.m58constructorimpl(Unit.INSTANCE));
    }
}
