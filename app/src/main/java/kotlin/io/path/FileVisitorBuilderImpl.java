...
public final class FileVisitorBuilderImpl implements FileVisitorBuilder {
    ...
    public void onPostVisitDirectory(@xi.k Function2<? super Path, ? super IOException, ? extends FileVisitResult> function) {
    ...
    @Override // kotlin.io.path.FileVisitorBuilder
    public void onPreVisitDirectory(@xi.k Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> function) {
        Intrinsics.checkNotNullParameter(function, "function");
        checkIsNotBuilt();
    ...
    @Override // kotlin.io.path.FileVisitorBuilder
    public void onVisitFile(@xi.k Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> function) {
        Intrinsics.checkNotNullParameter(function, "function");
        checkIsNotBuilt();
    ...
    @Override // kotlin.io.path.FileVisitorBuilder
    public void onVisitFileFailed(@xi.k Function2<? super Path, ? super IOException, ? extends FileVisitResult> function) {
        Intrinsics.checkNotNullParameter(function, "function");
        checkIsNotBuilt();
