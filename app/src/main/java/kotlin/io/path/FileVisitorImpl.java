...
final class FileVisitorImpl extends SimpleFileVisitor<Path> {
    ...
    public FileVisitorImpl(@l Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> function2, @l Function2<? super Path, ? super BasicFileAttributes, ? extends FileVisitResult> function22, @l Function2<? super Path, ? super IOException, ? extends FileVisitResult> function23, @l Function2<? super Path, ? super IOException, ? extends FileVisitResult> function24) {
    ...
    @xi.k
    public FileVisitResult postVisitDirectory(@xi.k Path dir, @l IOException exc) {
        FileVisitResult a10;
    ...
    @xi.k
    public FileVisitResult visitFile(@xi.k Path r22, @xi.k BasicFileAttributes attrs) {
        FileVisitResult a10;
        Intrinsics.checkNotNullParameter(r22, "file");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Function2<Path, BasicFileAttributes, FileVisitResult> function2 = this.onVisitFile;
        if (function2 != null && (a10 = o.a(function2.invoke(r22, attrs))) != null) {
            return a10;
        }
        FileVisitResult visitFile = super.visitFile((FileVisitorImpl) r22, attrs);
        Intrinsics.checkNotNullExpressionValue(visitFile, "visitFile(...)");
        return visitFile;
    }

    @xi.k
    public FileVisitResult visitFileFailed(@xi.k Path r22, @xi.k IOException exc) {
        FileVisitResult a10;
        Intrinsics.checkNotNullParameter(r22, "file");
        Intrinsics.checkNotNullParameter(exc, "exc");
        Function2<Path, IOException, FileVisitResult> function2 = this.onVisitFileFailed;
        if (function2 != null && (a10 = o.a(function2.invoke(r22, exc))) != null) {
            return a10;
        }
        FileVisitResult visitFileFailed = super.visitFileFailed((FileVisitorImpl) r22, exc);
