...
final class ExceptionsCollector {
    ...
    public final void collect(@k Exception exception) {
        Throwable initCause;
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                ...
                exception = zh.l.a(initCause);
            }
            this.collectedExceptions.add(exception);
        }
    }

    public final void enterEntry(@k Path name) {
        Intrinsics.checkNotNullParameter(name, "name");
        Path path = this.path;
        this.path = path != null ? path.resolve(name) : null;
    }

    public final void exitEntry(@k Path name) {
        Intrinsics.checkNotNullParameter(name, "name");
        Path path = this.path;
