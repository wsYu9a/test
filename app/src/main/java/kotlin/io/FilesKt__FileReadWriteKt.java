...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final void appendText(@d File appendText, @d String text, @d Charset charset) {
    ...
    @InlineOnly
    private static final BufferedReader bufferedReader(@d File file, Charset charset, int i2) {
    ...
    @InlineOnly
    private static final BufferedWriter bufferedWriter(@d File file, Charset charset, int i2) {
    ...
    public static final void forEachBlock(@d File forEachBlock, @d Function2<? super byte[], ? super Integer, Unit> action) {
        Intrinsics.checkParameterIsNotNull(forEachBlock, "$this$forEachBlock");
        Intrinsics.checkParameterIsNotNull(action, "action");
        forEachBlock(forEachBlock, 4096, action);
    }

    public static final void forEachLine(@d File forEachLine, @d Charset charset, @d Function1<? super String, Unit> action) {
    ...
    @InlineOnly
    private static final FileInputStream inputStream(@d File file) {
        return new FileInputStream(file);
    }

    @InlineOnly
    private static final FileOutputStream outputStream(@d File file) {
        return new FileOutputStream(file);
    }

    @InlineOnly
    private static final PrintWriter printWriter(@d File file, Charset charset) {
        Writer outputStreamWriter = new OutputStreamWriter(new FileOutputStream(file), charset);
    ...
    @d
    public static final byte[] readBytes(@d File readBytes) {
        ...
        try {
            ...
            if (i3 > 0) {
                ...
                if (read2 != -1) {
                    ExposingBufferByteArrayOutputStream exposingBufferByteArrayOutputStream = new ExposingBufferByteArrayOutputStream(o.a.q);
    ...
    @d
    public static final List<String> readLines(@d File readLines, @d Charset charset) {
    ...
    @d
    public static final String readText(@d File readText, @d Charset charset) {
    ...
    @InlineOnly
    private static final InputStreamReader reader(@d File file, Charset charset) {
    ...
    public static final <T> T useLines(@d File useLines, @d Charset charset, @d Function1<? super Sequence<String>, ? extends T> block) {
    ...
    public static final void writeBytes(@d File writeBytes, @d byte[] array) {
    ...
    public static final void writeText(@d File writeText, @d String text, @d Charset charset) {
    ...
    @InlineOnly
    private static final OutputStreamWriter writer(@d File file, Charset charset) {
    ...
    public static final void forEachBlock(@d File forEachBlock, int i2, @d Function2<? super byte[], ? super Integer, Unit> action) {
        int coerceAtLeast;
        Intrinsics.checkParameterIsNotNull(forEachBlock, "$this$forEachBlock");
        Intrinsics.checkParameterIsNotNull(action, "action");
