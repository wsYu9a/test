...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m1513adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1525constructorimpl(LongSaturatedMathKt.m1511saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }

    /* renamed from: differenceBetween-fRLX17w */
    public final long m1514differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: elapsedFrom-6eNON_k */
    public final long m1515elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark, DurationUnit.NANOSECONDS);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1522boximpl(m1516markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto */
    public long m1516markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1525constructorimpl(read());
    }
