...
public final /* data */ class IndexedValue<T> {
    ...
    public boolean equals(@l Object r52) {
        ...
        if (!(r52 instanceof IndexedValue)) {
            return false;
        }
        IndexedValue indexedValue = (IndexedValue) r52;
