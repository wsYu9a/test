...
public class CollectionsKt___CollectionsJvmKt extends CollectionsKt__ReversedViewsKt {
    @k
    public static final <R> List<R> filterIsInstance(@k Iterable<?> iterable, @k Class<R> klass) {
    ...
    @k
    public static final <C extends Collection<? super R>, R> C filterIsInstanceTo(@k Iterable<?> iterable, @k C destination, @k Class<R> klass) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
    ...
    /* renamed from: max */
    public static final /* synthetic */ Double m485max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m493maxOrNull((Iterable<Double>) iterable);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min */
    public static final /* synthetic */ Double m487min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m501minOrNull((Iterable<Double>) iterable);
    }
    ...
    public static <T> void reverse(@k List<T> list) {
    ...
    @k
    public static final <T extends Comparable<? super T>> SortedSet<T> toSortedSet(@k Iterable<? extends T> iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: max */
    public static final /* synthetic */ Float m486max(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m494maxOrNull((Iterable<Float>) iterable);
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    /* renamed from: min */
    public static final /* synthetic */ Float m488min(Iterable iterable) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        return CollectionsKt___CollectionsKt.m502minOrNull((Iterable<Float>) iterable);
    }

    @k
    public static final <T> SortedSet<T> toSortedSet(@k Iterable<? extends T> iterable, @k Comparator<? super T> comparator) {
        Intrinsics.checkNotNullParameter(iterable, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
