...
class MapsKt___MapsKt extends MapsKt___MapsJvmKt {
    ...
    public static final <K, V> boolean any(@k Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return !map.isEmpty();
    }
    ...
    @k
    public static final <K, V> Sequence<Map.Entry<K, V>> asSequence(@k Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @k
    public static final <K, V, R> List<R> flatMap(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Iterable<? extends R>> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(transform, "transform");
    ...
    public static final <K, V, R> List<R> flatMapSequence(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Sequence<? extends R>> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(transform, "transform");
        ArrayList arrayList = new ArrayList();
        Iterator<Map.Entry<? extends K, ? extends V>> it = map.entrySet().iterator();
    ...
    @OverloadResolutionByLambdaReturnType
    public static final <K, V, R, C extends Collection<? super R>> C flatMapSequenceTo(@k Map<? extends K, ? extends V> map, @k C destination, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Sequence<? extends R>> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @k
    public static final <K, V, R, C extends Collection<? super R>> C flatMapTo(@k Map<? extends K, ? extends V> map, @k C destination, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends Iterable<? extends R>> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        Intrinsics.checkNotNullParameter(transform, "transform");
        Iterator<Map.Entry<? extends K, ? extends V>> it = map.entrySet().iterator();
    ...
    @HidesMembers
    public static final <K, V> void forEach(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, Unit> action) {
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @k
    public static final <K, V, R> List<R> map(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(transform, "transform");
    ...
    @k
    public static final <K, V, R> List<R> mapNotNull(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(transform, "transform");
        ArrayList arrayList = new ArrayList();
        Iterator<Map.Entry<? extends K, ? extends V>> it = map.entrySet().iterator();
    ...
    @k
    public static final <K, V, R, C extends Collection<? super R>> C mapNotNullTo(@k Map<? extends K, ? extends V> map, @k C destination, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        Intrinsics.checkNotNullParameter(transform, "transform");
        Iterator<Map.Entry<? extends K, ? extends V>> it = map.entrySet().iterator();
    ...
    @k
    public static final <K, V, R, C extends Collection<? super R>> C mapTo(@k Map<? extends K, ? extends V> map, @k C destination, @k Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
        Intrinsics.checkNotNullParameter(transform, "transform");
        Iterator<Map.Entry<? extends K, ? extends V>> it = map.entrySet().iterator();
    ...
    public static final <K, V> boolean none(@k Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        return map.isEmpty();
    }
    ...
    @k
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEach(@k M m10, @k Function1<? super Map.Entry<? extends K, ? extends V>, Unit> action) {
    ...
    @SinceKotlin(version = "1.4")
    @k
    public static final <K, V, M extends Map<? extends K, ? extends V>> M onEachIndexed(@k M m10, @k Function2<? super Integer, ? super Map.Entry<? extends K, ? extends V>, Unit> action) {
        Intrinsics.checkNotNullParameter(m10, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
    ...
    @k
    public static final <K, V> List<Pair<K, V>> toList(@k Map<? extends K, ? extends V> map) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        if (map.size() == 0) {
    ...
    public static final <K, V> boolean any(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        if (map.isEmpty()) {
            return false;
    ...
    public static final <K, V> int count(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        int i10 = 0;
        if (map.isEmpty()) {
    ...
    public static final <K, V> boolean none(@k Map<? extends K, ? extends V> map, @k Function1<? super Map.Entry<? extends K, ? extends V>, Boolean> predicate) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(predicate, "predicate");
        if (map.isEmpty()) {
            return true;
