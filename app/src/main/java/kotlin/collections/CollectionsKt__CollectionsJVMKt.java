...
public class CollectionsKt__CollectionsJVMKt {
    ...
    @k
    @PublishedApi
    public static <E> List<E> build(@k List<E> builder) {
    ...
    @k
    public static final <T> Object[] copyToArrayOfAny(@k T[] tArr, boolean z10) {
    ...
    @k
    public static <T> List<T> shuffled(@k Iterable<? extends T> iterable) {
    ...
    @k
    public static <T> T[] terminateCollectionToArray(int i10, @k T[] array) {
