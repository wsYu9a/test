...
public final class FlowableRepeatUntil<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    public static final class RepeatSubscriber<T> extends AtomicInteger implements FlowableSubscriber<T> {
        ...
        /* renamed from: sa */
        final SubscriptionArbiter f27095sa;
        ...
        public RepeatSubscriber(Subscriber<? super T> subscriber, BooleanSupplier booleanSupplier, SubscriptionArbiter subscriptionArbiter, Publisher<? extends T> publisher) {
            ...
            this.f27095sa = subscriptionArbiter;
        ...
        public void onSubscribe(Subscription subscription) {
            this.f27095sa.setSubscription(subscription);
        }

        public void subscribeNext() {
            if (getAndIncrement() == 0) {
                int i10 = 1;
                while (!this.f27095sa.isCancelled()) {
                    long j10 = this.produced;
                    if (j10 != 0) {
                        this.produced = 0L;
                        this.f27095sa.produced(j10);
                    }
