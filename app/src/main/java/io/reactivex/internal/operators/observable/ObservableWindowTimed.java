...
public final class ObservableWindowTimed<T> extends AbstractObservableWithUpstream<T, Observable<T>> {
                ...
                if (z11) {
                    ...
                    if (j10 >= this.maxSize) {
                        ...
                        if (this.restartTimerOnMaxSize) {
                            ...
                            if (!e.a(this.timer, disposable, schedulePeriodically)) {
    ...
    public static final class WindowSkipObserver<T> extends QueueDrainObserver<T, Object, Observable<T>> implements Disposable, Runnable {
        ...
        public final class CompletionTask implements Runnable {
            ...
            /* renamed from: w */
            private final UnicastSubject<T> f27127w;

            public CompletionTask(UnicastSubject<T> unicastSubject) {
                this.f27127w = unicastSubject;
            }

            @Override // java.lang.Runnable
            public void run() {
                WindowSkipObserver.this.complete(this.f27127w);
            }
        }
        ...
        public void drainLoop() {
            ...
            while (!this.terminated) {
                ...
                if (z11) {
                    ...
                    if (!subjectWork.open) {
                        list.remove(subjectWork.f27128w);
                        subjectWork.f27128w.onComplete();
