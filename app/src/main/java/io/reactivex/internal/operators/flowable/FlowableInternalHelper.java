...
public final class FlowableInternalHelper {
    ...
    public static final class FlatMapWithCombinerInner<U, R, T> implements Function<U, R> {
        ...
        public R apply(U u10) throws Exception {
            return this.combiner.apply(this.f27091t, u10);
        }
    }
    ...
    public static final class FlatMapWithCombinerOuter<T, R, U> implements Function<T, Publisher<R>> {
        ...
        public Publisher<R> apply(T t10) throws Exception {
            return new FlowableMapPublisher((Publisher) ObjectHelper.requireNonNull(this.mapper.apply(t10), "The mapper returned a null Publisher"), new FlatMapWithCombinerInner(this.combiner, t10));
        }
    }
    ...
    public static final class ItemDelayFunction<T, U> implements Function<T, Publisher<T>> {
        ...
        public Publisher<T> apply(T t10) throws Exception {
            return new FlowableTakePublisher((Publisher) ObjectHelper.requireNonNull(this.itemDelay.apply(t10), "The itemDelay returned a null Publisher"), 1L).map(Functions.justFunction(t10)).defaultIfEmpty(t10);
        }
    }
