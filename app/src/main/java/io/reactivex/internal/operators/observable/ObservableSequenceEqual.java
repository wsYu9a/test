    ...
    public static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        public void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f27120v1 == null) {
                    this.f27120v1 = spscLinkedArrayQueue.poll();
                }
                boolean z12 = this.f27120v1 == null;
                if (this.f27121v2 == null) {
                    this.f27121v2 = spscLinkedArrayQueue2.poll();
                }
                T t10 = this.f27121v2;
                ...
                if (!z12 && !z13) {
                    try {
                        if (!this.comparer.test(this.f27120v1, t10)) {
                            cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                            this.downstream.onNext(Boolean.FALSE);
                            this.downstream.onComplete();
                            return;
