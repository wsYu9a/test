...
public enum NotificationLite {
    ...
    public static final class ErrorNotification implements Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ErrorNotification) {
                return ObjectHelper.equals(this.f27153e, ((ErrorNotification) obj).f27153e);
            }
            return false;
        }

        public int hashCode() {
            return this.f27153e.hashCode();
        }

        public String toString() {
            return "NotificationLite.Error[" + this.f27153e + "]";
        }
    }
    ...
    public static <T> boolean accept(Object obj, Subscriber<? super T> subscriber) {
        ...
        if (obj instanceof ErrorNotification) {
            subscriber.onError(((ErrorNotification) obj).f27153e);
            return true;
        }
    ...
    public static Throwable getError(Object obj) {
        return ((ErrorNotification) obj).f27153e;
    }
    ...
    public static <T> boolean accept(Object obj, Observer<? super T> observer) {
        ...
        if (obj instanceof ErrorNotification) {
            observer.onError(((ErrorNotification) obj).f27153e);
            return true;
        }
        observer.onNext(obj);
        return false;
