...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1652deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1654deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public boolean equals(@l Object r52) {
        if (!(r52 instanceof ConnectionSpec)) {
            return false;
        }
        if (r52 == this) {
            return true;
        ...
        ConnectionSpec connectionSpec = (ConnectionSpec) r52;
