...
public final class RealConnectionPool {
    ...
    public RealConnectionPool(@k TaskRunner taskRunner, int i10, long j10, @k TimeUnit timeUnit) {
        ...
        this.cleanupTask = new Task(Intrinsics.stringPlus(Util.okHttpName, " ConnectionPool")) { // from class: okhttp3.internal.connection.RealConnectionPool$cleanupTask$1
            public RealConnectionPool$cleanupTask$1(String str) {
    ...
    public final boolean callAcquirePooledConnection(@k Address address, @k RealCall r52, @l List<Route> routes, boolean requireMultiplexed) {
        ...
        while (it.hasNext()) {
            ...
            synchronized (connection) {
                ...
                if (connection.isEligible$okhttp(address, routes)) {
                    r52.acquireConnectionNoEvents(connection);
                    return true;
                }
