...
public final class ExchangeFinder {
    ...
    */
    ...
    public final void trackFailure(@k IOException r32) {
        Intrinsics.checkNotNullParameter(r32, "e");
        this.nextRouteToTry = null;
        if ((r32 instanceof StreamResetException) && ((StreamResetException) r32).errorCode == ErrorCode.REFUSED_STREAM) {
            this.refusedStreamCount++;
        } else if (r32 instanceof ConnectionShutdownException) {
