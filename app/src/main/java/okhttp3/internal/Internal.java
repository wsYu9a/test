...
public final class Internal {
    @k
    public static final Headers.Builder addHeaderLenient(@k Headers.Builder builder, @k String line) {
        Intrinsics.checkNotNullParameter(builder, "builder");
        Intrinsics.checkNotNullParameter(line, "line");
        return builder.addLenient$okhttp(line);
    }

    public static final void applyConnectionSpec(@k ConnectionSpec connectionSpec, @k SSLSocket sslSocket, boolean z10) {
    ...
    @k
    public static final String cookieToString(@k Cookie cookie, boolean z10) {
        Intrinsics.checkNotNullParameter(cookie, "cookie");
        return cookie.toString$okhttp(z10);
    }

    @l
    public static final Cookie parseCookie(long j10, @k HttpUrl url, @k String setCookie) {
    ...
    @k
    public static final Headers.Builder addHeaderLenient(@k Headers.Builder builder, @k String name, @k String value) {
        Intrinsics.checkNotNullParameter(builder, "builder");
