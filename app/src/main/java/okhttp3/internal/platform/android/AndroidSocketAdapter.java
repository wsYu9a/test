...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        @k
        public final DeferredSocketAdapter.Factory factory(@k String packageName) {
            Intrinsics.checkNotNullParameter(packageName, "packageName");
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                final /* synthetic */ String $packageName;

                public AndroidSocketAdapter$Companion$factory$1(String packageName2) {
                ...
                public boolean matchesSocket(@k SSLSocket sslSocket) {
                    ...
                    return StringsKt.startsWith$default(name, Intrinsics.stringPlus(packageName, b.f29697h), false, 2, (Object) null);
                }
            };
        }
