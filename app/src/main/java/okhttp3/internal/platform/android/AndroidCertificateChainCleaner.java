...
public final class AndroidCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public AndroidCertificateChainCleaner(@k X509TrustManager trustManager, @k X509TrustManagerExtensions x509TrustManagerExtensions) {
        Intrinsics.checkNotNullParameter(trustManager, "trustManager");
    ...
    public List<Certificate> clean(@k List<? extends Certificate> chain, @k String hostname) throws SSLPeerUnverifiedException {
        ...
        try {
            List<X509Certificate> checkServerTrusted = this.x509TrustManagerExtensions.checkServerTrusted((X509Certificate[]) array, d.f25247a, hostname);
    ...
    public boolean equals(@l Object r22) {
        return (r22 instanceof AndroidCertificateChainCleaner) && ((AndroidCertificateChainCleaner) r22).trustManager == this.trustManager;
    }
