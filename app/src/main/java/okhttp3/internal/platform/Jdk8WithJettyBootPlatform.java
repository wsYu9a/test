...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    public static final class AlpnProvider implements InvocationHandler {
        ...
        public AlpnProvider(@k List<String> protocols) {
        ...
        @l
        public Object invoke(@k Object proxy, @k Method r82, @l Object[] args) throws Throwable {
            ...
            Class<?> returnType = r82.getReturnType();
            ...
            if ((!Intrinsics.areEqual(name, "protocolSelected") && !Intrinsics.areEqual(name, "selected")) || args.length != 1) {
                return r82.invoke(this, Arrays.copyOf(args, args.length));
            }
            Object obj3 = args[0];
            if (obj3 == null) {
                throw new NullPointerException("null cannot be cast to non-null type kotlin.String");
    ...
    public Jdk8WithJettyBootPlatform(@k Method putMethod, @k Method getMethod, @k Method removeMethod, @k Class<?> clientProviderClass, @k Class<?> serverProviderClass) {
