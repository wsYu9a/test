...
public final class WebSocketProtocol {
    ...
    @k
    public final String acceptHeader(@k String r32) {
        Intrinsics.checkNotNullParameter(r32, "key");
        return ByteString.INSTANCE.encodeUtf8(Intrinsics.stringPlus(r32, ACCEPT_MAGIC)).sha1().base64();
    }
    ...
    public final void toggleMask(@k Buffer.UnsafeCursor cursor, @k byte[] r92) {
        ...
        do {
            ...
            if (bArr != null) {
                while (i11 < i12) {
                    int i13 = i10 % length;
                    bArr[i11] = (byte) (bArr[i11] ^ r92[i13]);
                    i11++;
                    i10 = i13 + 1;
                }
            }
