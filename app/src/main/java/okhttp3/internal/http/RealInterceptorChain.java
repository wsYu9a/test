...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(@k RealCall call, @k List<? extends Interceptor> interceptors, int i10, @l Exchange exchange, @k Request request, int i11, int i12, int i13) {
    ...
    @k
    public final RealInterceptorChain copy$okhttp(int index, @l Exchange exchange, @k Request request, int connectTimeoutMillis, int readTimeoutMillis, int writeTimeoutMillis) {
        Intrinsics.checkNotNullParameter(request, "request");
    ...
    @Override // okhttp3.Interceptor.Chain
    @k
    public Response proceed(@k Request request) throws IOException {
        Intrinsics.checkNotNullParameter(request, "request");
    ...
    @Override // okhttp3.Interceptor.Chain
    @k
    public Interceptor.Chain withConnectTimeout(int timeout, @k TimeUnit unit) {
    ...
    @Override // okhttp3.Interceptor.Chain
    @k
    public Interceptor.Chain withReadTimeout(int timeout, @k TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if (this.exchange == null) {
    ...
    @Override // okhttp3.Interceptor.Chain
    @k
    public Interceptor.Chain withWriteTimeout(int timeout, @k TimeUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if (this.exchange == null) {
