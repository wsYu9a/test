...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    @l
    public Request authenticate(@l Route route, @k Response response) throws IOException {
        Address address;
    ...
    public JavaNetAuthenticator(@k Dns defaultDns) {
