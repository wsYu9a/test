...
public final class Hpack {
    ...
    public static final class Reader {
        ...
        @JvmOverloads
        public Reader(@k Source source, int i10) {
        ...
        @JvmOverloads
        public Reader(@k Source source, int i10, int i11) {
            Intrinsics.checkNotNullParameter(source, "source");
    ...
    public static final class Writer {
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        @JvmOverloads
        public Writer(int i10, @k Buffer out) {
        ...
        public final void writeByteString(@k ByteString r52) throws IOException {
            Intrinsics.checkNotNullParameter(r52, "data");
            if (this.useCompression) {
                Huffman huffman = Huffman.INSTANCE;
                if (huffman.encodedLength(r52) < r52.size()) {
                    Buffer buffer = new Buffer();
                    huffman.encode(r52, buffer);
        ...
        */
        public final void writeHeaders(@xi.k java.util.List<okhttp3.internal.http2.Header> r14) throws java.io.IOException {
            /*
        ...
        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        @JvmOverloads
        public Writer(@k Buffer out) {
            this(0, false, out, 3, null);
            Intrinsics.checkNotNullParameter(out, "out");
        }

        @JvmOverloads
        public Writer(int i10, boolean z10, @k Buffer out) {
            Intrinsics.checkNotNullParameter(out, "out");
            this.headerTableSizeSetting = i10;
    ...
    static {
        ...
        STATIC_HEADER_TABLE = new Header[]{header, header2, header3, header4, header5, header6, header7, new Header(byteString4, "200"), new Header(byteString4, "204"), new Header(byteString4, "206"), new Header(byteString4, "304"), new Header(byteString4, "400"), new Header(byteString4, ck.f7038b), new Header(byteString4, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header(SpJsonConstants.CACHE_CONTROL, ""), new Header("content-disposition", ""), new Header("content-encoding", ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header(e.f26401f, ""), new Header("cookie", ""), new Header("date", ""), new Header(f.f19041c, ""), new Header("expect", ""), new Header(a.f30752g, ""), new Header(TypedValues.TransitionType.S_FROM, ""), new Header(c.f33638f, ""), new Header("if-match", ""), new Header(DownloadUtils.IF_MODIFIED_SINCE, ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header(d.f30256x, ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header("transfer-encoding", ""), new Header("user-agent", ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    @k
    public final ByteString checkLowercase(@k ByteString name) throws IOException {
