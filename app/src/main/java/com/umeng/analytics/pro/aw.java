...
public final class aw {
    ...
    /* renamed from: a */
    private static final Comparator f25715a = new a();
    ...
    public static int a(List list, List list2) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            int compare = f25715a.compare(list.get(i2), list2.get(i2));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int compare = f25715a.compare(it.next(), it2.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f25715a;
