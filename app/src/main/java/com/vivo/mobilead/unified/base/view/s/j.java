...
public class j extends o {
    ...
    protected void c(com.vivo.ad.model.b bVar, AdParams adParams) {
        ...
        if (q.a(bVar)) {
            ...
            layoutParams.topMargin = com.vivo.mobilead.util.m.a(getContext(), this.q * 5.0f);
            linearLayout2.addView(a(bVar, sourceAppend, layoutParams));
        }
        ...
        layoutParams2.setMargins(com.vivo.mobilead.util.m.a(getContext(), 13.33f), 0, 0, 0);
