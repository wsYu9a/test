...
public class NRatioLayout extends RatioLayout implements INativeLayout {
    private static final String TAG = "NRatioLayout_TMTEST";
    ...
    @Override // com.vivo.advv.vaf.virtualview.layout.RatioLayout, com.vivo.advv.vaf.virtualview.core.ViewBase, com.vivo.advv.vaf.virtualview.core.IView
    public void onComLayout(boolean z, int i2, int i3, int i4, int i5) {
        this.mNative.onLayout(z, i2, i3, i4, i5);
    }

    @Override // com.vivo.advv.vaf.virtualview.layout.RatioLayout, com.vivo.advv.vaf.virtualview.core.IView
