...
public final class k extends AsyncTask<String, Void, List<Bitmap>> {
    ...
    /* renamed from: b */
    private InsideNotificationItem f31098b;
    ...
    public k(Context context, InsideNotificationItem insideNotificationItem, long j2, boolean z, r.a aVar) {
        ...
        this.f31098b = insideNotificationItem;
        this.f31099c = j2;
        this.f31100d = z;
        this.f31102f = aVar;
    }
    ...
    */
    public java.util.List<android.graphics.Bitmap> doInBackground(java.lang.String... r10) {
        /*
            r9 = this;
            com.vivo.push.model.InsideNotificationItem r0 = r9.f31098b
            int r0 = r0.getNotifyDisplayStatus()
            r9.f31101e = r0
            boolean r0 = r9.f31100d
            r1 = 0
