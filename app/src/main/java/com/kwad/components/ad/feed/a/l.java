...
public final class l extends a implements View.OnClickListener, com.kwad.sdk.widget.c {
    ...
    /* renamed from: com.kwad.components.ad.feed.a.l$1 */
    ...
    private void c(View view, int i2) {
        if (view == this.eC) {
            ...
            com.kwad.components.core.d.b.a.a(new a.C0172a(getContext()).I(this.mAdTemplate).an(5).ao(i2).b(this.mApkDownloadHelper).ap(view == this.eH ? 1 : 2).ao(view == this.eH).a(new a.b() { // from class: com.kwad.components.ad.feed.a.l.1
                final /* synthetic */ int eK;
