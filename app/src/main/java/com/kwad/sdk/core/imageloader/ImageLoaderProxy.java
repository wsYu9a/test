...
public enum ImageLoaderProxy implements IImageLoader {
    ...
    public final void load(@NonNull Context context, ImageView imageView, Object obj, int i2, int i3) {
    ...
    @Override // com.kwad.sdk.service.kwai.g
    public final void load(@NonNull KsFragment ksFragment, @NonNull String str, @NonNull ImageView imageView, @NonNull Drawable drawable, @NonNull Drawable drawable2, float f2) {
