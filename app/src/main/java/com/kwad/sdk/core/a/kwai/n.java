...
public final class n implements com.kwad.sdk.core.d<AdMatrixInfo.AdDataV2> {
    ...
    private static void a2(AdMatrixInfo.AdDataV2 adDataV2, JSONObject jSONObject) {
        ...
        adDataV2.rewardWatchOnceInfo = baseMatrixTemplate11;
        baseMatrixTemplate11.parseJson(jSONObject.optJSONObject("rewardWatchOnceInfo"));
        ...
        adDataV2.mRewardWebTaskCloseInfo = rewardWebTaskCloseInfo;
        rewardWebTaskCloseInfo.parseJson(jSONObject.optJSONObject("mRewardWebTaskCloseInfo"));
        ...
        adDataV2.splashActionBarInfo = baseMatrixTemplate12;
        baseMatrixTemplate12.parseJson(jSONObject.optJSONObject("splashActionBarInfo"));
        AdMatrixInfo.BaseMatrixTemplate baseMatrixTemplate13 = new AdMatrixInfo.BaseMatrixTemplate();
        adDataV2.videoLiveTKInfo = baseMatrixTemplate13;
        baseMatrixTemplate13.parseJson(jSONObject.optJSONObject("videoLiveTKInfo"));
    ...
    private static JSONObject b2(AdMatrixInfo.AdDataV2 adDataV2, JSONObject jSONObject) {
        ...
        com.kwad.sdk.utils.t.a(jSONObject, "rewardWatchOnceInfo", adDataV2.rewardWatchOnceInfo);
