...
public class b extends i implements AdRequestParam.ADLoadListener {

    /* renamed from: g */
    private static String f15228g = "KSHTAG";
    ...
    public void G(IMultiAdObject iMultiAdObject) {
        com.martian.ttbook.b.c.a.a.e.d.g(f15228g, "ad loaded");
        ...
        if (iMultiAdObject != null) {
            ...
            arrayList.add(new c(iMultiAdObject, this.f15662c, this.f15663d, this.f15661b));
        }
    ...
    public void onAdFailed(String str) {
        com.martian.ttbook.b.c.a.a.e.d.c(f15228g, "onAdError %s", str);
        D(new com.martian.ttbook.b.c.a.a.d.b.i(-3000, str));
    }
    ...
    public void w() {
        ...
        com.martian.ttbook.b.c.a.a.e.d.g(f15228g, "slotId = " + l);
        AdRequestParam build = new AdRequestParam.Builder().adslotID(l).adType(3).adLoadListener(this).build();
        com.martian.ttbook.b.c.a.a.e.d.g(f15228g, "load ad");
        if (e2 != null) {
            e2.invokeADV(build);
        }
