...
public class c extends i implements TTAdNative.NativeExpressAdListener, d.b {

    /* renamed from: g */
    public TTAdNative f15496g;
    ...
    public void f(d dVar) {
        ...
        if (dVar != null) {
            boolean g2 = kVar.c(k.b.n, dVar.f15210a).g(this.f15663d, dVar.i(), this.f15497h, dVar.f15218j);
            kVar.h();
    ...
    public void j(d dVar) {
        ...
        if (dVar.k()) {
            this.f15497h = System.currentTimeMillis();
    ...
    public void onNativeExpressAdLoad(List<TTNativeExpressAd> list) {
        ...
        for (TTNativeExpressAd tTNativeExpressAd : list) {
            if (!F() || !com.martian.ttbook.b.c.a.a.b.a.d.y.a.f(this.f15663d, tTNativeExpressAd)) {
                arrayList.add(new d(tTNativeExpressAd, this.f15662c, this.f15663d, this.f15661b, this));
            }
        }
    ...
    public void w() {
        ...
        this.f15496g = com.martian.ttbook.b.c.a.a.b.a.d.y.c.b().createAdNative(this.f15662c.f15670d.getApplicationContext());
        ...
        this.f15496g.loadNativeExpressAd(build, this);
