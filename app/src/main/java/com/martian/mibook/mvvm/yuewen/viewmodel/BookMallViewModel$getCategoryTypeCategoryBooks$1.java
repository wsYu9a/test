...
@DebugMetadata(c = "com.martian.mibook.mvvm.yuewen.viewmodel.BookMallViewModel$getCategoryTypeCategoryBooks$1", f = "BookMallViewModel.kt", i = {}, l = {TTDownloadField.CALL_DOWNLOAD_MODEL_GET_START_TOAST}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class BookMallViewModel$getCategoryTypeCategoryBooks$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public BookMallViewModel$getCategoryTypeCategoryBooks$1(YWBookChannelBooksParams yWBookChannelBooksParams, BookMallViewModel bookMallViewModel, boolean z10, Continuation<? super BookMallViewModel$getCategoryTypeCategoryBooks$1> continuation) {
    ...
    public final Continuation<Unit> create(@l Object obj, @k Continuation<?> continuation) {
        return new BookMallViewModel$getCategoryTypeCategoryBooks$1(this.$bookMallParams, this.this$0, this.$isAddEvent, continuation);
    }
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        if (yWChannelBookList == null || (bookList = yWChannelBookList.getBookList()) == null || !bookList.isEmpty()) {
            ...
            mutableLiveData = bookMallViewModel._mCategoryBooksLiveData;
            mutableLiveData.postValue(bookList2);
        } else {
            mutableLiveData2 = bookMallViewModel._mCategoryBooksLiveData;
    ...
    public final Object invoke(@k CoroutineScope coroutineScope, @l Continuation<? super Unit> continuation) {
        return ((BookMallViewModel$getCategoryTypeCategoryBooks$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
