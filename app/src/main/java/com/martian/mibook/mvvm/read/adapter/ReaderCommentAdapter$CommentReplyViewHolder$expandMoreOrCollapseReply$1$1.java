...
@DebugMetadata(c = "com.martian.mibook.mvvm.read.adapter.ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1", f = "ReaderCommentAdapter.kt", i = {}, l = {438}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes3.dex */
public final class ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends CommentReply>>, Object> {
    final /* synthetic */ Comment $comment;
    int label;
    final /* synthetic */ ReaderCommentAdapter this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1(Comment comment, ReaderCommentAdapter readerCommentAdapter, Continuation<? super ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1> continuation) {
    ...
    public final Continuation<Unit> create(@l Object obj, @k Continuation<?> continuation) {
        return new ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1(this.$comment, this.this$0, continuation);
    }
    ...
    public final Object invoke2(@k CoroutineScope coroutineScope, @l Continuation<? super List<CommentReply>> continuation) {
        return ((ReaderCommentAdapter$CommentReplyViewHolder$expandMoreOrCollapseReply$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
