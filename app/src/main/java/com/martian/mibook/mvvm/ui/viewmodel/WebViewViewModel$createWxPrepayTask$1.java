...
@DebugMetadata(c = "com.martian.mibook.mvvm.ui.viewmodel.WebViewViewModel$createWxPrepayTask$1", f = "WebViewViewModel.kt", i = {}, l = {64}, m = "invokeSuspend", n = {}, s = {})
@SourceDebugExtension({"SMAP\nWebViewViewModel.kt\nKotlin\n*S Kotlin\n*F\n+ 1 WebViewViewModel.kt\ncom/martian/mibook/mvvm/ui/viewmodel/WebViewViewModel$createWxPrepayTask$1\n+ 2 ArrayMap.kt\nandroidx/collection/ArrayMapKt\n*L\n1#1,77:1\n22#2:78\n*S KotlinDebug\n*F\n+ 1 WebViewViewModel.kt\ncom/martian/mibook/mvvm/ui/viewmodel/WebViewViewModel$createWxPrepayTask$1\n*L\n59#1:78\n*E\n"})
/* loaded from: classes3.dex */
public final class WebViewViewModel$createWxPrepayTask$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public WebViewViewModel$createWxPrepayTask$1(int i10, String str, String str2, WebViewViewModel webViewViewModel, Continuation<? super WebViewViewModel$createWxPrepayTask$1> continuation) {
    ...
    public final Continuation<Unit> create(@l Object obj, @k Continuation<?> continuation) {
        return new WebViewViewModel$createWxPrepayTask$1(this.$money, this.$productId, this.$extra, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(@k Object obj) {
        ...
        if (i10 == 0) {
            ...
            arrayMap.put("wx_appid", MiConfigSingleton.b2().c2().getRechargeWxAppid());
    ...
    public final Object invoke(@k CoroutineScope coroutineScope, @l Continuation<? super Unit> continuation) {
        return ((WebViewViewModel$createWxPrepayTask$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
