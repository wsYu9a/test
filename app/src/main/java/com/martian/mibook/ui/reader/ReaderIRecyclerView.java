...
public class ReaderIRecyclerView extends NestRecyclerview {
    ...
    /* renamed from: f */
    private static final String f14803f = ReaderIRecyclerView.class.getSimpleName();

    /* renamed from: g */
    private static final int f14804g = 0;

    /* renamed from: h */
    private static final int f14805h = 1;

    /* renamed from: i */
    private static final int f14806i = 2;

    /* renamed from: j */
    private static final int f14807j = 3;
    ...
    final com.martian.libmars.widget.recyclerview.h.b G;
    private int l;
    private boolean m;
    private boolean n;
    private int o;
    ...
    class a extends com.martian.libsupport.recyclerView.b {
        ...
        public void b(RecyclerView recyclerView) {
            if (ReaderIRecyclerView.this.q == null || ReaderIRecyclerView.this.l != 0) {
                return;
            }
            ReaderIRecyclerView.this.q.onLoadMore(ReaderIRecyclerView.this.x);
        }
    }
    ...
    class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            int i2 = ReaderIRecyclerView.this.l;
            if (i2 == 1 || i2 == 2) {
                ReaderIRecyclerView.this.G.a(false, true, intValue);
            } else {
                if (i2 != 3) {
                    return;
                }
                ReaderIRecyclerView.this.G.a(true, true, intValue);
            }
        }
    }
    ...
    class c extends com.martian.libmars.widget.recyclerview.f.d {
        ...
        public void onAnimationEnd(Animator animation) {
            int unused = ReaderIRecyclerView.this.l;
            int i2 = ReaderIRecyclerView.this.l;
            if (i2 == 1) {
                if (!ReaderIRecyclerView.this.m) {
                    ReaderIRecyclerView.this.s.getLayoutParams().height = 0;
                    ReaderIRecyclerView.this.s.requestLayout();
                    ReaderIRecyclerView.this.setStatus(0);
                    return;
                }
                ReaderIRecyclerView.this.s.getLayoutParams().height = ReaderIRecyclerView.this.w.getMeasuredHeight();
                ReaderIRecyclerView.this.s.requestLayout();
                ReaderIRecyclerView.this.setStatus(3);
                if (ReaderIRecyclerView.this.p != null) {
                    ReaderIRecyclerView.this.p.onRefresh();
                    ReaderIRecyclerView.this.G.onRefresh();
                    return;
                }
                return;
            }
            if (i2 != 2) {
                ...
                ReaderIRecyclerView.this.m = false;
                ReaderIRecyclerView.this.s.getLayoutParams().height = 0;
                ReaderIRecyclerView.this.s.requestLayout();
                ReaderIRecyclerView.this.setStatus(0);
                ReaderIRecyclerView.this.G.d();
                return;
            }
            ReaderIRecyclerView.this.s.getLayoutParams().height = ReaderIRecyclerView.this.w.getMeasuredHeight();
            ReaderIRecyclerView.this.s.requestLayout();
    ...
    class d implements com.martian.libmars.widget.recyclerview.h.b {
        ...
        public void a(boolean finished, boolean automatic, int moved) {
            if (ReaderIRecyclerView.this.w == null || !(ReaderIRecyclerView.this.w instanceof com.martian.libmars.widget.recyclerview.h.b)) {
                return;
            }
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).a(finished, automatic, moved);
        }
        ...
        public void b(boolean automatic, int headerHeight, int finalHeight) {
            ...
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).b(automatic, headerHeight, finalHeight);
        }
        ...
        public void c() {
            ...
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).c();
        }
        ...
        public void d() {
            ...
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).d();
        }
        ...
        public void onRefresh() {
            ...
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).onRefresh();
        }
        ...
        public void onRelease() {
            ...
            ((com.martian.libmars.widget.recyclerview.h.b) ReaderIRecyclerView.this.w).onRelease();
        }
    }
    ...
    public boolean o() {
        ...
        if (view instanceof ReaderLoadMoreFooterView) {
            return ((ReaderLoadMoreFooterView) view).a();
        }
        return false;
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r9) {
        ...
        L35:
            ...
            if (r0 >= 0) goto L59
            java.lang.String r9 = com.martian.mibook.ui.reader.ReaderIRecyclerView.f14803f
    ...
    public void setLoadMoreEndStatus(String desc) {
        View view = this.x;
        if (view instanceof ReaderLoadMoreFooterView) {
            ((ReaderLoadMoreFooterView) view).setEndStatus(desc);
        }
    }
    ...
    public ReaderIRecyclerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReaderIRecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            if (i2 != -1) {
                ...
                this.y = com.martian.ttbookhd.R.layout.layout_irecyclerview_classic_refresh_header;
                setRefreshHeaderView(com.martian.ttbookhd.R.layout.layout_irecyclerview_classic_refresh_header);
            }
            int i3 = this.z;
            if (i3 != -1) {
                setLoadMoreFooterView(i3);
            } else if (z2) {
                this.z = com.martian.ttbookhd.R.layout.layout_reader_irecyclerview_load_more_footer;
                setLoadMoreFooterView(com.martian.ttbookhd.R.layout.layout_reader_irecyclerview_load_more_footer);
            }
