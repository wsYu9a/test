...
public final class BookShelfBatchTopViewBinding implements ViewBinding {
    ...
    private BookShelfBatchTopViewBinding(@NonNull ThemeLinearLayout themeLinearLayout, @NonNull ThemeTextView themeTextView, @NonNull ThemeTextView themeTextView2, @NonNull ThemeTextView themeTextView3, @NonNull ThemeLinearLayout themeLinearLayout2) {
        ...
        if (themeTextView != null) {
            ...
            if (themeTextView2 != null) {
                ...
                if (themeTextView3 != null) {
                    ...
                    return new BookShelfBatchTopViewBinding(themeLinearLayout, themeTextView, themeTextView2, themeTextView3, themeLinearLayout);
                }
            }
        }
