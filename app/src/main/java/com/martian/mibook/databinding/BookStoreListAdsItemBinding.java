...
public final class BookStoreListAdsItemBinding implements ViewBinding {
    ...
    @NonNull
    public static BookStoreListAdsItemBinding bind(@NonNull View view) {
                                        ...
                                        if (textView != null) {
                                            ...
                                            if (themeTextView != null) {
                                                ...
                                                if (themeTextView2 != null) {
                                                    return new BookStoreListAdsItemBinding(frameLayout, frameLayout, linearLayout, imageView, imageView2, relativeLayout, frameLayout2, findChildViewById, relativeLayout2, themeLinearLayout, themeLinearLayout2, textView, themeTextView, themeTextView2);
                                                }
                                            }
                                        }
                                    }
    ...
    @NonNull
    public static BookStoreListAdsItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static BookStoreListAdsItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
