...
public final class BookStoreGridAdsItemBinding implements ViewBinding {
    ...
    @NonNull
    public static BookStoreGridAdsItemBinding bind(@NonNull View view) {
                            ...
                            if (linearLayout3 != null) {
                                ...
                                if (textView != null) {
                                    ...
                                    if (themeTextView != null) {
                                        return new BookStoreGridAdsItemBinding(frameLayout, frameLayout, linearLayout, findChildViewById, imageView, imageView2, frameLayout2, linearLayout2, linearLayout3, textView, themeTextView);
                                    }
                                }
                            }
                        }
    ...
    @NonNull
    public static BookStoreGridAdsItemBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static BookStoreGridAdsItemBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
        View inflate = layoutInflater.inflate(R.layout.book_store_grid_ads_item, viewGroup, false);
        if (z10) {
