...
public final class ItemBookStoreBinding implements ViewBinding {
    ...
    private ItemBookStoreBinding(@NonNull ThemeLinearLayout themeLinearLayout, @NonNull BookCoverImageView bookCoverImageView, @NonNull FrameLayout frameLayout, @NonNull ThemeTextView themeTextView, @NonNull TextView textView, @NonNull ThemeTextView themeTextView2, @NonNull TextView textView2, @NonNull ThemeTextView themeTextView3) {
        ...
        this.tvBookScore = textView2;
        this.tvBookShortContent = themeTextView3;
    }

    @NonNull
    public static ItemBookStoreBinding bind(@NonNull View view) {
                        ...
                        if (themeTextView2 != null) {
                            ...
                            if (textView2 != null) {
                                ...
                                if (themeTextView3 != null) {
                                    return new ItemBookStoreBinding((ThemeLinearLayout) view, bookCoverImageView, frameLayout, themeTextView, textView, themeTextView2, textView2, themeTextView3);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static ItemBookStoreBinding inflate(@NonNull LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    @NonNull
    public static ItemBookStoreBinding inflate(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z10) {
