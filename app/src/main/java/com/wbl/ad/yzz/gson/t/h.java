...
public final class h {
    ...
    /* renamed from: a */
    public static final Map<Class<?>, Class<?>> f32294a;
    ...
    static {
        ...
        f32294a = Collections.unmodifiableMap(hashMap);
    ...
    public static boolean a(Type type) {
        return f32294a.containsKey(type);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = (Class) f32294a.get(a.a(cls));
