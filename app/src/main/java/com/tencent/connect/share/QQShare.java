...
public class QQShare extends BaseApi {
    ...
    class AnonymousClass1 implements c {
        ...
        /* renamed from: a */
        final /* synthetic */ Bundle f25291a;
        ...
        /* renamed from: d */
        final /* synthetic */ IUiListener f25294d;

        /* renamed from: e */
        final /* synthetic */ Activity f25295e;

        AnonymousClass1(Bundle bundle, String str, String str2, IUiListener iUiListener, Activity activity) {
            bundle = bundle;
            string2 = str;
            string3 = str2;
        ...
        public void a(int i2, String str) {
            if (i2 == 0) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, ((BaseApi) QQShare.this).f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_GETIMG_ERROR);
                return;
            }
    ...
    class AnonymousClass2 implements c {
        ...
        /* renamed from: a */
        final /* synthetic */ Bundle f25297a;
        ...
        /* renamed from: d */
        final /* synthetic */ IUiListener f25300d;

        /* renamed from: e */
        final /* synthetic */ Activity f25301e;

        AnonymousClass2(Bundle bundle, String str, String str2, IUiListener iUiListener, Activity activity) {
            bundle = bundle;
            string2 = str;
            string3 = str2;
            iUiListener = iUiListener;
    ...
    public void shareToQQ(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (i2 == 6) {
            if (i.f(activity, "5.0.0")) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, app share is not support below qq5.0.");
                return;
            }
            string4 = String.format("http://fusion.qq.com/cgi-bin/qzapps/unified_jump?appid=%1$s&from=%2$s&isOpenAppID=1", this.f25282b.getAppId(), "mqq");
        ...
        if (!i.b() && i.f(activity, "4.5.0")) {
            ...
            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ sdcard is null");
            return;
        }
        if (i2 == 5) {
            if (i.f(activity, "4.3.0")) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, version below 4.3 is not support.");
                return;
            } else if (!i.h(string5)) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR, null));
                f.e("openSDK_LOG.QQShare", "shareToQQ -- error: 非法的图片地址!");
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_PARAM_IMAGE_URL_FORMAT_ERROR);
                return;
            }
        }
        if (i2 != 5) {
            if (TextUtils.isEmpty(string4) || !(string4.startsWith("http://") || string4.startsWith("https://"))) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, targetUrl is empty or illegal..");
                return;
            } else if (TextUtils.isEmpty(string2)) {
                iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_TITLE_NULL_ERROR, null));
                f.e("openSDK_LOG.QQShare", "shareToQQ, title is empty.");
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, title is empty.");
                return;
            }
        }
        if (!TextUtils.isEmpty(string) && !string.startsWith("http://") && !string.startsWith("https://") && !new File(string).exists()) {
            ...
            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, image url is emprty or illegal.");
            return;
        }
        ...
        if (TextUtils.isEmpty(string)) {
            ...
            if (i.f(activity, "4.3.0")) {
                ...
                a.a(activity, string, new c() { // from class: com.tencent.connect.share.QQShare.2
                    ...
                    AnonymousClass2(Bundle bundle2, String string22, String string32, IUiListener iUiListener2, Activity activity2) {
                        bundle = bundle2;
                        string2 = string22;
                        string3 = string32;
            ...
            if (TextUtils.isEmpty(string22) && TextUtils.isEmpty(string32)) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f25282b.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_NOSD_ERROR);
                return;
            }
            if (i.f(activity2, "4.3.0")) {
                new b(activity2).a(string, new c() { // from class: com.tencent.connect.share.QQShare.1
                    ...
                    AnonymousClass1(Bundle bundle2, String string22, String string32, IUiListener iUiListener2, Activity activity2) {
                        bundle = bundle2;
                        string2 = string22;
                        string3 = string32;
                        iUiListener = iUiListener2;
