...
public class a extends f implements TTFullScreenVideoAd.FullScreenVideoAdInteractionListener {

    /* renamed from: p */
    private TTFullScreenVideoAd f5619p;

    /* renamed from: q */
    private AtomicBoolean f5620q;

    /* renamed from: r */
    private AtomicBoolean f5621r;

    /* renamed from: s */
    private String f5622s;

    /* renamed from: com.aggmoread.sdk.z.d.a.a.d.a.d.s.d.f.a$a */
    public class C0151a implements TTAdNative.FullScreenVideoAdListener {
        ...
        public void onFullScreenVideoAdLoad(TTFullScreenVideoAd tTFullScreenVideoAd) {
            a.this.f5619p = tTFullScreenVideoAd;
            a.this.B();
        }
    ...
    public class c implements Runnable {
        ...
        public void run() {
            ...
            l.a(((f) a.this).f5328n, 3);
        }
    }

    public a(d dVar, e eVar) {
        super(dVar, eVar);
        this.f5620q = new AtomicBoolean();
        this.f5621r = new AtomicBoolean();
        this.f5622s = "msdk-user";
    }

    private void A() {
        if (this.f5621r.compareAndSet(false, true)) {
            l.a(this.f5328n, 2);
            x();
        }
    }
    ...
    private void D() {
        com.aggmoread.sdk.z.d.a.a.d.a.d.s.d.b.a(this.f5841f, this.f5619p);
    }
    ...
    private void z() {
        ...
        AdSlot build = new AdSlot.Builder().setCodeId(this.f5843h.f5907c.c(obj)).setUserID(this.f5622s).setUserData(a12).setOrientation(y()).setMediationAdSlot(new MediationAdSlot.Builder().setMuted(d10).setBidNotify(true).setRewardName(this.f5842g.f5870p.d()).setRewardAmount(this.f5842g.f5870p.b()).setExtraObject("gromoreExtra", a12).build()).build();
        new k(this.f5842g, this.f5843h).a(0).b();
        createAdNative.loadFullScreenVideoAd(build, new C0151a());
    }
    ...
    public void destroy() {
        TTFullScreenVideoAd tTFullScreenVideoAd = this.f5619p;
        if (tTFullScreenVideoAd == null || tTFullScreenVideoAd.getMediationManager() == null) {
            return;
        }
        this.f5619p.getMediationManager().destroy();
        this.f5619p = null;
    }
    ...
    public void b(Activity activity) {
        ...
        if (tTFullScreenVideoAd != null) {
            boolean z10 = tTFullScreenVideoAd.getMediationManager() != null && this.f5619p.getMediationManager().isReady();
            com.aggmoread.sdk.z.d.a.a.e.e.b("AMITAGCSJ", "showAd isReady = " + z10);
            if (z10 && this.f5620q.compareAndSet(false, true)) {
                com.aggmoread.sdk.z.d.a.a.e.e.b("AMITAGCSJ", "show");
                if (activity == null) {
                    super.b();
                } else {
                    this.f5619p.setFullScreenVideoAdInteractionListener(this);
                    this.f5619p.showFullScreenVideoAd(activity);
                }
            }
        }
    }
