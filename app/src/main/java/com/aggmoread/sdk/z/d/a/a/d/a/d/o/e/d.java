...
public class d extends com.aggmoread.sdk.z.d.a.a.d.a.d.d {
    ...
    /* renamed from: w */
    private com.aggmoread.sdk.z.b.l.c f5401w;

    /* renamed from: x */
    private String f5402x;

    public class a implements f {

        /* renamed from: f */
        final /* synthetic */ f.a f5403f;
    ...
    public class b implements e.a {
        ...
        /* renamed from: a */
        final /* synthetic */ com.aggmoread.sdk.z.d.a.a.c.t.a f5405a;
        ...
        public void a() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaStart");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
                aVar.onVideoStart();
            }
        }
        ...
        @Override // com.aggmoread.sdk.z.b.l.e.a
        public void b() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaReady ");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
                aVar.onVideoReady();
            }
        ...
        @Override // com.aggmoread.sdk.z.b.l.e.a
        public void c() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaCompleted ");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
        ...
        @Override // com.aggmoread.sdk.z.b.l.e.a
        public void d() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaLoading");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
                aVar.onVideoLoading();
            }
        ...
        @Override // com.aggmoread.sdk.z.b.l.e.a
        public void e() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaResume");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
                aVar.onVideoResume();
            }
        ...
        @Override // com.aggmoread.sdk.z.b.l.e.a
        public void f() {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaPause ");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
                aVar.onVideoPause();
            }
        ...
        public void a(int i10) {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, "onMediaLoaded");
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
        ...
        public void a(com.aggmoread.sdk.z.b.g.e eVar) {
            com.aggmoread.sdk.z.d.a.a.e.e.b(d.this.f5402x, " onMediaError err " + eVar.toString());
            com.aggmoread.sdk.z.d.a.a.c.t.a aVar = this.f5405a;
            if (aVar != null) {
    ...
    public d(com.aggmoread.sdk.z.b.l.c cVar, com.aggmoread.sdk.z.d.a.a.d.b.d dVar, com.aggmoread.sdk.z.d.a.a.d.b.e eVar, Map<String, Object> map) {
        ...
        this.f5402x = "AMHTAG";
        this.f5401w = cVar;
        if (cVar instanceof com.aggmoread.sdk.z.a.h.b) {
            com.aggmoread.sdk.z.d.a.a.d.a.d.o.b.b(this.f5319p, ((com.aggmoread.sdk.z.a.h.b) cVar).g(), eVar);
        }
    }
    ...
    public View a(@NonNull Context context, @NonNull View view, FrameLayout.LayoutParams layoutParams, List<View> list, View view2, List<View> list2, View view3, @NonNull f.a aVar) {
        ...
        if (m.a(this.f5276i) && !list.contains(view4)) {
            com.aggmoread.sdk.z.d.a.a.e.e.b(this.f5402x, "ovov ");
            list.add(view4);
        }
        this.f5274g = aVar;
        if ((view instanceof com.aggmoread.sdk.z.d.a.a.d.b.m.a) && this.f5323t) {
            ...
            com.aggmoread.sdk.z.d.a.a.e.e.b(this.f5402x, "f n " + dVar);
        } else {
            aVar2 = null;
            dVar = null;
        }
        ...
        this.f5401w.a(dVar, list, new a(aVar));
    ...
    public int f() {
        return this.f5401w.getVideoDuration();
    }
    ...
    public String getIconUrl() {
        return this.f5401w.getIconUrl();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.c.o.f
    public String getImageUrl() {
        return this.f5401w.getImageUrl();
    }
    ...
    public String getTitle() {
        return this.f5401w.getTitle();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.d.a.d.d, com.aggmoread.sdk.z.d.a.a.c.o.f
    public int getVideoCurrentPosition() {
        return this.f5401w.getVideoCurrentPosition();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.c.o.f
    public boolean isAppAd() {
        return this.f5401w.isAppAd();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.c.o.f
    public boolean isVideoAd() {
        return this.f5401w.isVideoAd();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.d.a.d.d, com.aggmoread.sdk.z.d.a.a.c.o.f
    public void pauseVideo() {
        this.f5401w.pauseVideo();
    }
    ...
    public void startVideo() {
        this.f5401w.startVideo();
    }

    @Override // com.aggmoread.sdk.z.d.a.a.d.a.d.d, com.aggmoread.sdk.z.d.a.a.c.o.f
    public void stopVideo() {
        this.f5401w.stopVideo();
    }
    ...
    public void b(ViewGroup viewGroup, com.aggmoread.sdk.z.d.a.a.c.t.a aVar) {
        ...
        if (viewGroup instanceof g) {
            this.f5401w.a((g) viewGroup, bVar2.a(), new b(aVar));
        }
    }
