...
class FloatingActionButtonImpl {
    ...
    public class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass1(boolean z10, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            z10 = z10;
    ...
    public class AnonymousClass2 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass2(boolean z10, InternalVisibilityChangedListener internalVisibilityChangedListener) {
            z10 = z10;
            internalVisibilityChangedListener = internalVisibilityChangedListener;
        }
    ...
    private AnimatorSet createAnimator(@NonNull MotionSpec motionSpec, float f10, float f11, float f12) {
        ...
        ObjectAnimator ofObject = ObjectAnimator.ofObject(this.view, new ImageMatrixProperty(), new MatrixEvaluator() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.3
            ...
            @Override // com.google.android.material.animation.MatrixEvaluator, android.animation.TypeEvaluator
            public Matrix evaluate(float f102, @NonNull Matrix matrix, @NonNull Matrix matrix2) {
                FloatingActionButtonImpl.this.imageMatrixScale = f102;
                return super.evaluate(f102, matrix, matrix2);
            }
    ...
    public void hide(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z10) {
        if (isOrWillBeHidden()) {
            return;
        }
        ...
        createAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.1
            ...
            public AnonymousClass1(boolean z102, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                z10 = z102;
            ...
            public void onAnimationEnd(Animator animator2) {
                ...
                FloatingActionButton floatingActionButton = FloatingActionButtonImpl.this.view;
                boolean z102 = z10;
                floatingActionButton.internalSetVisibility(z102 ? 8 : 4, z102);
    ...
    public void show(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z10) {
        if (isOrWillBeShown()) {
            return;
        }
        Animator animator = this.currentAnimator;
        ...
        createAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.2
            ...
            public AnonymousClass2(boolean z102, InternalVisibilityChangedListener internalVisibilityChangedListener2) {
                z10 = z102;
                internalVisibilityChangedListener = internalVisibilityChangedListener2;
            }
