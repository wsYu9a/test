...
public class c {
    ...
    private static final ThreadLocal<Matrix> f7327a = new ThreadLocal<>();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f7328b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f7327a;
        ...
        ThreadLocal<RectF> threadLocal2 = f7328b;
