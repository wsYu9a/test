...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public class AnonymousClass3 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass3(MotionStrategy motionStrategy, OnChangedCallback onChangedCallback) {
    ...
    public void performMotion(@NonNull MotionStrategy motionStrategy, @Nullable OnChangedCallback onChangedCallback) {
        ...
        createAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.3
            ...
            public AnonymousClass3(MotionStrategy motionStrategy2, OnChangedCallback onChangedCallback2) {
        ...
        Iterator<Animator.AnimatorListener> it = motionStrategy2.getListeners().iterator();
        while (it.hasNext()) {
