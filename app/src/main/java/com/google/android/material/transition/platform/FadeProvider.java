...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(View view, float f10, float f11, @FloatRange(from = 0.0d, to = 1.0d) float f12, @FloatRange(from = 0.0d, to = 1.0d) float f13) {
