...
public final class b {
    ...
    public static final String f9092a = "AES/CBC/NoPadding";

    /* renamed from: b, reason: collision with root package name */
    public static final int f9093b = 16;

    /* renamed from: c, reason: collision with root package name */
    public static final String f9094c = "a3NyaXNrY3RsYnVzaW5zc3Z4cHprd3NwYWlvcXBrc3M=";

    /* renamed from: d, reason: collision with root package name */
    private static final String f9095d = "AES/CBC/PKCS5Padding";

    /* renamed from: e, reason: collision with root package name */
    private static final String f9096e = "AES";

    /* renamed from: f, reason: collision with root package name */
    private static final String f9097f = "AES/CBC/PKCS7Padding";

    public static byte[] a(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str.getBytes(), f9096e);
        Cipher cipher = Cipher.getInstance(f9095d);
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2, boolean z) {
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, f9096e);
            Cipher cipher = Cipher.getInstance(f9095d);
    ...
    public static byte[] b(String str, String str2, byte[] bArr) {
        SecretKeySpec secretKeySpec = new SecretKeySpec(str2.getBytes(), f9096e);
        Cipher cipher = Cipher.getInstance(f9095d);
