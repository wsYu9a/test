...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new Comparator<ItemInfo>() { // from class: androidx.viewpager.widget.ViewPager.1
        ...
        public int compare(ItemInfo itemInfo, ItemInfo itemInfo2) {
            return itemInfo.f4054b - itemInfo2.f4054b;
        }
    };
    ...
    class AnonymousClass4 implements OnApplyWindowInsetsListener {
        ...
        /* renamed from: a */
        private final Rect f4051a = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f4064b + "}";
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeParcelable(this.f4065c, i2);
        }
        ...
        SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f4065c = parcel.readParcelable(classLoader);
            this.f4066d = classLoader;
        }
    }
    ...
    static class ViewPositionComparator implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return z != layoutParams2.isDecor ? z ? 1 : -1 : layoutParams.f4060c - layoutParams2.f4060c;
        }
    }
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i2, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            int i5 = itemInfo2.f4054b;
            int i6 = itemInfo.f4054b;
            if (i5 < i6) {
                float f3 = itemInfo2.f4057e + itemInfo2.f4056d + f2;
                int i7 = i5 + 1;
                int i8 = 0;
                while (i7 <= itemInfo.f4054b && i8 < this.mItems.size()) {
                    ItemInfo itemInfo5 = this.mItems.get(i8);
                    while (true) {
                        itemInfo4 = itemInfo5;
                        if (i7 <= itemInfo4.f4054b || i8 >= this.mItems.size() - 1) {
                            break;
                        }
                        i8++;
                        itemInfo5 = this.mItems.get(i8);
                    }
                    while (i7 < itemInfo4.f4054b) {
                        f3 += this.mAdapter.getPageWidth(i7) + f2;
                        i7++;
                    }
                    itemInfo4.f4057e = f3;
                    f3 += itemInfo4.f4056d + f2;
                    i7++;
                }
            } else if (i5 > i6) {
                int size = this.mItems.size() - 1;
                float f4 = itemInfo2.f4057e;
                while (true) {
                    i5--;
                    if (i5 < itemInfo.f4054b || size < 0) {
                        break;
                    }
                    ItemInfo itemInfo6 = this.mItems.get(size);
                    while (true) {
                        itemInfo3 = itemInfo6;
                        if (i5 >= itemInfo3.f4054b || size <= 0) {
                            break;
                        }
                        size--;
                        itemInfo6 = this.mItems.get(size);
                    }
                    while (i5 > itemInfo3.f4054b) {
                        f4 -= this.mAdapter.getPageWidth(i5) + f2;
                        i5--;
                    }
                    f4 -= itemInfo3.f4056d + f2;
                    itemInfo3.f4057e = f4;
                }
            }
        }
        int size2 = this.mItems.size();
        float f5 = itemInfo.f4057e;
        int i9 = itemInfo.f4054b;
        int i10 = i9 - 1;
        this.mFirstOffset = i9 == 0 ? f5 : -3.4028235E38f;
        int i11 = count - 1;
        this.mLastOffset = i9 == i11 ? (itemInfo.f4056d + f5) - 1.0f : Float.MAX_VALUE;
        int i12 = i2 - 1;
        while (i12 >= 0) {
        ...
        float f6 = itemInfo.f4057e + itemInfo.f4056d + f2;
        int i13 = itemInfo.f4054b + 1;
        int i14 = i2 + 1;
        while (i14 < size2) {
            ...
            if (i3 == i11) {
                this.mLastOffset = (itemInfo8.f4056d + f6) - 1.0f;
            }
            itemInfo8.f4057e = f6;
            f6 += itemInfo8.f4056d + f2;
            i14++;
            i13++;
        }
        this.mNeedCalculatePageOffsets = false;
    ...
    private int determineTargetPage(int i2, float f2, int i3, int i4) {
        ...
        return Math.max(this.mItems.get(0).f4054b, Math.min(i2, this.mItems.get(r4.size() - 1).f4054b));
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i4 < this.mItems.size()) {
            ...
            if (!z && itemInfo2.f4054b != (i2 = i3 + 1)) {
                itemInfo2 = this.mTempItem;
                itemInfo2.f4057e = f2 + f4 + f3;
                itemInfo2.f4054b = i2;
                itemInfo2.f4056d = this.mAdapter.getPageWidth(i2);
                i4--;
            }
            f2 = itemInfo2.f4057e;
            float f5 = itemInfo2.f4056d + f2 + f3;
            if (!z && scrollX < f2) {
                return itemInfo;
            }
    ...
    private boolean pageScrolled(int i2) {
        ...
        int i5 = infoForCurrentScrollPosition.f4054b;
        float f3 = ((i2 / f2) - infoForCurrentScrollPosition.f4057e) / (infoForCurrentScrollPosition.f4056d + (i3 / f2));
        this.mCalledSuper = false;
    ...
    private boolean performDrag(float f2) {
        ...
        if (itemInfo.f4054b != 0) {
            f4 = itemInfo.f4057e * clientWidth;
            z = false;
        } else {
            z = true;
        }
        if (itemInfo2.f4054b != this.mAdapter.getCount() - 1) {
            f5 = itemInfo2.f4057e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
    ...
    private void recomputeScrollPosition(int i2, int i3, int i4, int i5) {
        ...
        int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.f4057e, this.mLastOffset) : 0.0f) * ((i2 - getPaddingLeft()) - getPaddingRight()));
        if (min != getScrollX()) {
    ...
    private void scrollToItem(int i2, boolean z, int i3, boolean z2) {
        ...
        int clientWidth = infoForPosition != null ? (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(infoForPosition.f4057e, this.mLastOffset))) : 0;
        if (z) {
    ...
    public void addFocusables(ArrayList<View> arrayList, int i2, int i3) {
        ...
        if (descendantFocusability != 393216) {
            for (int i4 = 0; i4 < getChildCount(); i4++) {
                ...
                if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f4054b == this.mCurItem) {
    ...
    ItemInfo addNewItem(int i2, int i3) {
        ...
        itemInfo.f4054b = i2;
        itemInfo.f4053a = this.mAdapter.instantiateItem((ViewGroup) this, i2);
        itemInfo.f4056d = this.mAdapter.getPageWidth(i2);
    ...
    */
    ...
    void dataSetChanged() {
        ...
        while (i3 < this.mItems.size()) {
            ...
            int itemPosition = this.mAdapter.getItemPosition(itemInfo.f4053a);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    this.mAdapter.destroyItem((ViewGroup) this, itemInfo.f4054b, itemInfo.f4053a);
                    int i4 = this.mCurItem;
                    if (i4 == itemInfo.f4054b) {
                        i2 = Math.max(0, Math.min(i4, count - 1));
                    }
                } else {
                    int i5 = itemInfo.f4054b;
                    if (i5 != itemPosition) {
                        if (i5 == this.mCurItem) {
                            i2 = itemPosition;
                        }
                        itemInfo.f4054b = itemPosition;
                    }
                }
                z = true;
            }
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f4054b == this.mCurItem && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void endFakeDrag() {
        ...
        if (this.mAdapter != null) {
            ...
            int scrollX = getScrollX();
            ItemInfo infoForCurrentScrollPosition = infoForCurrentScrollPosition();
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f4054b, ((scrollX / clientWidth) - infoForCurrentScrollPosition.f4057e) / infoForCurrentScrollPosition.f4056d, xVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), true, true, xVelocity);
        }
        endDrag();
    ...
    public void fakeDragBy(float f2) {
        ...
        if (itemInfo.f4054b != 0) {
            f3 = itemInfo.f4057e * clientWidth;
        }
        if (itemInfo2.f4054b != this.mAdapter.getCount() - 1) {
            f4 = itemInfo2.f4057e * clientWidth;
        }
        if (scrollX < f3) {
            scrollX = f3;
        } else if (scrollX > f4) {
    ...
    protected int getChildDrawingOrder(int i2, int i3) {
        ...
        return ((LayoutParams) this.mDrawingOrderedChildren.get(i3).getLayoutParams()).f4061d;
    }
    ...
    ItemInfo infoForChild(View view) {
        for (int i2 = 0; i2 < this.mItems.size(); i2++) {
            ItemInfo itemInfo = this.mItems.get(i2);
            if (this.mAdapter.isViewFromObject(view, itemInfo.f4053a)) {
                return itemInfo;
            }
        }
        return null;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i4 = itemInfo.f4054b;
        int i5 = this.mItems.get(size - 1).f4054b;
        while (i4 < i5) {
            while (true) {
                i2 = itemInfo.f4054b;
                if (i4 <= i2 || i3 >= size) {
            ...
            if (i4 == i2) {
                float f6 = itemInfo.f4057e;
                float f7 = itemInfo.f4056d;
                f2 = (f6 + f7) * width;
                f5 = f6 + f7 + f4;
            } else {
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i3 != i5) {
            ...
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f4054b == this.mCurItem && childAt.requestFocus(i2, rect)) {
                return true;
            }
            i3 += i4;
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (pagerAdapter != null) {
            pagerAdapter.restoreState(savedState.f4065c, savedState.f4066d);
            setCurrentItemInternal(savedState.f4064b, false, true);
        } else {
            this.mRestoredCurItem = savedState.f4064b;
            this.mRestoredAdapterState = savedState.f4065c;
            this.mRestoredClassLoader = savedState.f4066d;
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f4064b = this.mCurItem;
        PagerAdapter pagerAdapter = this.mAdapter;
        if (pagerAdapter != null) {
            savedState.f4065c = pagerAdapter.saveState();
        }
        return savedState;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f4054b, ((scrollX / f3) - infoForCurrentScrollPosition.f4057e) / (infoForCurrentScrollPosition.f4056d + (this.mPageMargin / f3)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
            z = resetTouch();
        }
        if (z) {
            ViewCompat.postInvalidateOnAnimation(this);
    ...
    void setCurrentItemInternal(int i2, boolean z, boolean z2, int i3) {
        ...
        if (i2 > i5 + i4 || i2 < i5 - i4) {
            for (int i6 = 0; i6 < this.mItems.size(); i6++) {
                this.mItems.get(i6).f4055c = true;
            }
        }
