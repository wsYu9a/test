...
public final class ContextAwareKt {
    @l
    public static final <R> Object withContextAvailable(@k ContextAware contextAware, @k Function1<? super Context, ? extends R> function1, @k Continuation<? super R> continuation) {
