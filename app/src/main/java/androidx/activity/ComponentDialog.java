...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner {
    ...
    @JvmOverloads
    public ComponentDialog(@k Context context) {
    ...
    public void addContentView(@k View view, @l ViewGroup.LayoutParams params) {
    ...
    @JvmOverloads
    public ComponentDialog(@k Context context, @StyleRes int i10) {
        super(context, i10);
        Intrinsics.checkNotNullParameter(context, "context");
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() { // from class: e.e
            public /* synthetic */ e() {
            }
    ...
    @Override // android.app.Dialog
    public void setContentView(@k View view, @l ViewGroup.LayoutParams params) {
        Intrinsics.checkNotNullParameter(view, "view");
        initViewTreeOwners();
