...
public abstract class AbstractResolvableFuture<V> implements c0<V> {
    ...
    public static final class SetFuture<V> implements Runnable {
        final c0<? extends V> future;
        final AbstractResolvableFuture<V> owner;

        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, c0<? extends V> c0Var) {
    ...
    static {
        ...
        try {
            synchronizedHelper = new SafeAtomicHelper(AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Thread.class, "thread"), AtomicReferenceFieldUpdater.newUpdater(Waiter.class, Waiter.class, c.f26970g), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Waiter.class, "waiters"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Listener.class, "listeners"), AtomicReferenceFieldUpdater.newUpdater(AbstractResolvableFuture.class, Object.class, "value"));
            th = null;
        } catch (Throwable th2) {
            th = th2;
    ...
    public static Object getFutureValue(c0<?> c0Var) {
        if (c0Var instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) c0Var).value;
            if (!(obj instanceof Cancellation)) {
                return obj;
            }
        ...
        try {
            Object uninterruptibly = getUninterruptibly(c0Var);
            return uninterruptibly == null ? NULL : uninterruptibly;
        } catch (CancellationException e10) {
            if (isCancelled) {
                return new Cancellation(false, e10);
            }
            return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + c0Var, e10));
        } catch (ExecutionException e11) {
    ...
    public final boolean cancel(boolean z10) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                c0<? extends V> c0Var = ((SetFuture) obj).future;
                if (!(c0Var instanceof AbstractResolvableFuture)) {
                    c0Var.cancel(z10);
                    return true;
                }
                abstractResolvableFuture = (AbstractResolvableFuture) c0Var;
    ...
    public boolean setFuture(c0<? extends V> c0Var) {
        ...
        if (obj == null) {
            if (c0Var.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(c0Var))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, c0Var);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    c0Var.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th2) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            c0Var.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
