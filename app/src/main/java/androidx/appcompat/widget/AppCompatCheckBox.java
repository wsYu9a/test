...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView {
    ...
    /* renamed from: a */
    private final AppCompatCompoundButtonHelper f688a;

    /* renamed from: b */
    private final AppCompatBackgroundHelper f689b;

    /* renamed from: c */
    private final AppCompatTextHelper f690c;
    ...
    protected void drawableStateChanged() {
        ...
        AppCompatBackgroundHelper appCompatBackgroundHelper = this.f689b;
        if (appCompatBackgroundHelper != null) {
            appCompatBackgroundHelper.b();
        }
        AppCompatTextHelper appCompatTextHelper = this.f690c;
    ...
    public int getCompoundPaddingLeft() {
        ...
        AppCompatCompoundButtonHelper appCompatCompoundButtonHelper = this.f688a;
