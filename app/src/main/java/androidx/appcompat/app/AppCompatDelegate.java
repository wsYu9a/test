...
public abstract class AppCompatDelegate {
    ...
    /* renamed from: a */
    static final String f223a = "AppCompatDelegate";

    /* renamed from: b */
    private static int f224b = -100;

    /* renamed from: c */
    private static final ArraySet<WeakReference<AppCompatDelegate>> f225c = new ArraySet<>();

    /* renamed from: d */
    private static final Object f226d = new Object();
    ...
    private static void a() {
        synchronized (f226d) {
            Iterator<WeakReference<AppCompatDelegate>> it = f225c.iterator();
            while (it.hasNext()) {
    ...
    static void b(@NonNull AppCompatDelegate appCompatDelegate) {
        synchronized (f226d) {
            d(appCompatDelegate);
            f225c.add(new WeakReference<>(appCompatDelegate));
        }
    }
    ...
    public static void setDefaultNightMode(int i2) {
        if (i2 != -1 && i2 != 0 && i2 != 1 && i2 != 2 && i2 != 3) {
            Log.d(f223a, "setDefaultNightMode() called with an unknown mode");
        } else if (f224b != i2) {
            f224b = i2;
            a();
        }
