...
public final class Recreator implements LifecycleEventObserver {
    ...
    public static final class SavedStateProvider implements SavedStateRegistry.SavedStateProvider {
        ...
        public final void add(@k String r22) {
            Intrinsics.checkNotNullParameter(r22, "className");
            this.classes.add(r22);
        }
    ...
    private final void reflectiveNew(String r52) {
        try {
            Class<? extends U> asSubclass = Class.forName(r52, false, Recreator.class.getClassLoader()).asSubclass(SavedStateRegistry.AutoRecreated.class);
            ...
            try {
                ...
                try {
                    ...
                    throw new RuntimeException("Failed to instantiate " + r52, e10);
                }
            } catch (NoSuchMethodException e11) {
                throw new IllegalStateException("Class " + asSubclass.getSimpleName() + " must have default constructor in order to be automatically recreated", e11);
            }
        } catch (ClassNotFoundException e12) {
            throw new RuntimeException("Class " + r52 + " wasn't found", e12);
        }
    }
