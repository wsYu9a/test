            ...
            synchronized (this.mLock) {
                try {
                    ...
                    if (this.mObserver == null) {
                        AnonymousClass1 anonymousClass1 = new ContentObserver(handler) { // from class: androidx.emoji2.text.FontRequestEmojiCompatConfig.FontRequestMetadataLoader.1
                    ...
                    handler2.postDelayed(this.mMainHandlerLoadCallback, j10);
                } catch (Throwable th2) {
                    throw th2;
                }
            }
