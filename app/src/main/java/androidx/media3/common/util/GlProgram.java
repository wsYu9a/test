...
public final class GlProgram {
    ...
    public static final class Attribute {
        ...
        public static Attribute create(int i10, int i11) {
            ...
            return new Attribute(str, i11, GlProgram.getAttributeLocation(i10, str));
        }
    ...
    public GlProgram(String str, String str2) throws GlUtil.GlException {
        ...
        for (int i10 = 0; i10 < iArr2[0]; i10++) {
            Attribute create = Attribute.create(this.programId, i10);
            this.attributes[i10] = create;
        ...
        for (int i11 = 0; i11 < iArr3[0]; i11++) {
            Uniform create2 = Uniform.create(this.programId, i11);
            this.uniforms[i11] = create2;
