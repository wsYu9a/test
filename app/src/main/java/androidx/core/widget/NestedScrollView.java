...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public boolean executeKeyEvent(@NonNull KeyEvent keyEvent) {
        ...
        if (!canScroll) {
            ...
            View findNextFocus = FocusFinder.getInstance().findNextFocus(this, findFocus, c.m);
            return (findNextFocus == null || findNextFocus == this || !findNextFocus.requestFocus(c.m)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            return !keyEvent.isAltPressed() ? arrowScroll(c.m) : fullScroll(c.m);
        }
        if (keyCode != 62) {
            return false;
        }
