...
public final class ContextKt {
    ...
    public static final void withStyledAttributes(@k Context context, @l AttributeSet attributeSet, @k int[] attrs, @AttrRes int i10, @StyleRes int i11, @k Function1<? super TypedArray, Unit> block) {
        Intrinsics.checkNotNullParameter(context, "<this>");
    ...
    public static final void withStyledAttributes(@k Context context, @StyleRes int i10, @k int[] attrs, @k Function1<? super TypedArray, Unit> block) {
        Intrinsics.checkNotNullParameter(context, "<this>");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        Intrinsics.checkNotNullParameter(block, "block");
