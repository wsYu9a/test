...
public final class LocationRequestCompat {
    ...
    @FloatRange(from = l5.c.f27899e, to = 3.4028234663852886E38d)
    ...
    public String toString() {
        ...
        if (this.mMinUpdateDistanceMeters > l5.c.f27899e) {
    ...
    public LocationRequest toLocationRequest(@NonNull String str) {
        return Build.VERSION.SDK_INT >= 31 ? toLocationRequest() : x.q.a(Api19Impl.toLocationRequest(this, str));
    }
