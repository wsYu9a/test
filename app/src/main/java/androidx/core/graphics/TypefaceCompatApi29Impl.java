...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    private Font findBaseFont(@NonNull FontFamily fontFamily, int i10) {
        FontStyle fontStyle = new FontStyle((i10 & 1) != 0 ? TypedValues.TransitionType.TYPE_DURATION : 400, (i10 & 2) != 0 ? 1 : 0);
    ...
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i10) {
        ...
        try {
            ...
            while (i11 < length) {
                ...
                try {
                    openFileDescriptor = contentResolver.openFileDescriptor(fontInfo.getUri(), t.f11211k, cancellationSignal);
                } catch (IOException unused) {
                }
