...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public class AnonymousClass1 implements View.OnAttachStateChangeListener {
        ...
        public AnonymousClass1(FragmentStateManager fragmentStateManager) {
            createOrGetFragmentStateManager = fragmentStateManager;
        }
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        findFragmentById.mView.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: androidx.fragment.app.FragmentLayoutInflaterFactory.1
            ...
            public AnonymousClass1(FragmentStateManager createOrGetFragmentStateManager2) {
                createOrGetFragmentStateManager = createOrGetFragmentStateManager2;
            }
