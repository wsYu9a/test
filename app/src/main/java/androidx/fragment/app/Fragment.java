...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public Object getReenterTransition() {
        ...
        Object obj = animationInfo.f2342j;
    ...
    public Object getReturnTransition() {
        ...
        Object obj = animationInfo.f2340h;
    ...
    public ViewModelStore getViewModelStore() {
        ...
        if (fragmentManagerImpl != null) {
            return fragmentManagerImpl.P(this);
        }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (this.mChildFragmentManager.T(1)) {
            return;
        }
    ...
    void performSaveInstanceState(Bundle bundle) {
        ...
        Parcelable n0 = this.mChildFragmentManager.n0();
        if (n0 != null) {
    ...
    void restoreChildFragmentState(@Nullable Bundle bundle) {
        ...
        this.mChildFragmentManager.l0(parcelable);
        this.mChildFragmentManager.dispatchCreate();
    }
    ...
    void setAnimatingAway(View view) {
        ensureAnimationInfo().f2333a = view;
    }

    void setAnimator(Animator animator) {
        ensureAnimationInfo().f2334b = animator;
    }
    ...
    public void setEnterTransition(@Nullable Object obj) {
        ensureAnimationInfo().f2339g = obj;
    }
    ...
    public void setExitTransition(@Nullable Object obj) {
        ensureAnimationInfo().f2341i = obj;
    }
    ...
    public void setInitialSavedState(@Nullable SavedState savedState) {
        ...
        if (savedState == null || (bundle = savedState.f2343a) == null) {
            bundle = null;
        }
    ...
    void setNextTransition(int i2, int i3) {
        ...
        ensureAnimationInfo();
        AnimationInfo animationInfo = this.mAnimationInfo;
        animationInfo.f2337e = i2;
        animationInfo.f2338f = i3;
    }
    ...
    public void setReenterTransition(@Nullable Object obj) {
        ensureAnimationInfo().f2342j = obj;
    }
    ...
    public void setReturnTransition(@Nullable Object obj) {
        ensureAnimationInfo().f2340h = obj;
    }
    ...
    public void startPostponedEnterTransition() {
        ...
        } else if (Looper.myLooper() != this.mFragmentManager.z.a().getLooper()) {
            this.mFragmentManager.z.a().postAtFrontOfQueue(new Runnable() { // from class: androidx.fragment.app.Fragment.3
                AnonymousClass3() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        public void writeToParcel(@NonNull Parcel parcel, int i2) {
            parcel.writeBundle(this.f2343a);
        }

        SavedState(@NonNull Parcel parcel, @Nullable ClassLoader classLoader) {
            Bundle readBundle = parcel.readBundle();
            this.f2343a = readBundle;
    ...
    public final void postponeEnterTransition(long j2, @NonNull TimeUnit timeUnit) {
        ensureAnimationInfo().q = true;
        FragmentManagerImpl fragmentManagerImpl = this.mFragmentManager;
        Handler a2 = fragmentManagerImpl != null ? fragmentManagerImpl.z.a() : new Handler(Looper.getMainLooper());
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (fragmentHostCallback != null) {
            ...
            LayoutInflaterCompat.setFactory2(onGetLayoutInflater, this.mChildFragmentManager.O());
            return onGetLayoutInflater;
        }
