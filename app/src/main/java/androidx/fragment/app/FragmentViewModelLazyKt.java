...
public final class FragmentViewModelLazyKt {
    ...
    public static final /* synthetic */ Lazy createViewModelLazy(Fragment fragment, KClass viewModelClass, Function0 storeProducer, Function0 function0) {
        ...
        return createViewModelLazy(fragment, viewModelClass, storeProducer, new Function0<CreationExtras>() { // from class: androidx.fragment.app.FragmentViewModelLazyKt$createViewModelLazy$1
            public FragmentViewModelLazyKt$createViewModelLazy$1() {
                super(0);
            }
    ...
    public static /* synthetic */ Lazy viewModels$default(Fragment fragment, Function0 ownerProducer, Function0 function0, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            ownerProducer = new Function0<Fragment>() { // from class: androidx.fragment.app.FragmentViewModelLazyKt$viewModels$1
                public FragmentViewModelLazyKt$viewModels$1() {
                    super(0);
                }
    ...
    public static final ViewModelStoreOwner m16viewModels$lambda0(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }

    /* renamed from: viewModels$lambda-1 */
    public static final ViewModelStoreOwner m17viewModels$lambda1(Lazy<? extends ViewModelStoreOwner> lazy) {
        return lazy.getValue();
    }
    ...
    @k
    @MainThread
    public static final <VM extends ViewModel> Lazy<VM> createViewModelLazy(@k Fragment fragment, @k KClass<VM> viewModelClass, @k Function0<? extends ViewModelStore> storeProducer, @k Function0<? extends CreationExtras> extrasProducer, @l Function0<? extends ViewModelProvider.Factory> function0) {
        Intrinsics.checkNotNullParameter(fragment, "<this>");
        Intrinsics.checkNotNullParameter(viewModelClass, "viewModelClass");
        Intrinsics.checkNotNullParameter(storeProducer, "storeProducer");
        ...
        if (function0 == null) {
            function0 = new Function0<ViewModelProvider.Factory>() { // from class: androidx.fragment.app.FragmentViewModelLazyKt$createViewModelLazy$factoryPromise$1
                public FragmentViewModelLazyKt$createViewModelLazy$factoryPromise$1() {
                    super(0);
                }
    ...
    public static /* synthetic */ Lazy createViewModelLazy$default(Fragment fragment, KClass kClass, Function0 function0, Function0 function02, Function0 function03, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            function02 = new Function0<CreationExtras>() { // from class: androidx.fragment.app.FragmentViewModelLazyKt$createViewModelLazy$2
                public FragmentViewModelLazyKt$createViewModelLazy$2() {
                    super(0);
                }
    ...
    public static /* synthetic */ Lazy viewModels$default(Fragment fragment, Function0 ownerProducer, Function0 function0, Function0 function02, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            ownerProducer = new Function0<Fragment>() { // from class: androidx.fragment.app.FragmentViewModelLazyKt$viewModels$5
                public FragmentViewModelLazyKt$viewModels$5() {
                    super(0);
                }
