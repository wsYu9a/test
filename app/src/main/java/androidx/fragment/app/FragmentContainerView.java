...
public final class FragmentContainerView extends FrameLayout {
    ...
    public static final class Api20Impl {
        ...
        @k
        public final WindowInsets onApplyWindowInsets(@k View.OnApplyWindowInsetsListener onApplyWindowInsetsListener, @k View v10, @k WindowInsets insets) {
    ...
    @JvmOverloads
    public FragmentContainerView(@k Context context, @l AttributeSet attributeSet) {
    ...
    public void addView(@k View child, int index, @l ViewGroup.LayoutParams params) {
    ...
    @k
    @RequiresApi(20)
    public WindowInsets dispatchApplyWindowInsets(@k WindowInsets insets) {
    ...
    @Override // android.view.ViewGroup
    public boolean drawChild(@k Canvas canvas, @k View child, long drawingTime) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(child, "child");
    ...
    @Override // android.view.ViewGroup
    public void endViewTransition(@k View view) {
    ...
    @k
    @RequiresApi(20)
    public WindowInsets onApplyWindowInsets(@k WindowInsets insets) {
        Intrinsics.checkNotNullParameter(insets, "insets");
        return insets;
    }
    ...
    public void removeView(@k View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        addDisappearingFragmentView(view);
    ...
    @Override // android.view.ViewGroup
    public void removeViewInLayout(@k View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        addDisappearingFragmentView(view);
    ...
    @Override // android.view.ViewGroup
    public void removeViews(int start, int r62) {
        int i10 = start + r62;
        ...
        super.removeViews(start, r62);
    }

    @Override // android.view.ViewGroup
    public void removeViewsInLayout(int start, int r62) {
        int i10 = start + r62;
        for (int i11 = start; i11 < i10; i11++) {
            View view = getChildAt(i11);
            Intrinsics.checkNotNullExpressionValue(view, "view");
        ...
        super.removeViewsInLayout(start, r62);
    }
    ...
    @Override // android.view.ViewGroup
    public void setLayoutTransition(@l LayoutTransition transition) {
        throw new UnsupportedOperationException("FragmentContainerView does not support Layout Transitions or animateLayoutChanges=\"true\".");
    }

    @Override // android.view.View
    public void setOnApplyWindowInsetsListener(@k View.OnApplyWindowInsetsListener listener) {
        Intrinsics.checkNotNullParameter(listener, "listener");
        this.applyWindowInsetsListener = listener;
    }

    @Override // android.view.ViewGroup
    public void startViewTransition(@k View view) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public FragmentContainerView(@k Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public FragmentContainerView(@k Context context, @l AttributeSet attributeSet, int i10) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FragmentContainerView(@k Context context, @k AttributeSet attrs, @k FragmentManager fm) {
        super(context, attrs);
        String str;
        Intrinsics.checkNotNullParameter(context, "context");
