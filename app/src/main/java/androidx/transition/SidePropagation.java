...
public class SidePropagation extends VisibilityPropagation {
    ...
    /* renamed from: d */
    private float f3802d = 3.0f;

    /* renamed from: e */
    private int f3803e = 80;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0026, code lost:
        ...
        if ((androidx.core.view.ViewCompat.getLayoutDirection(r7) == 1) != false) goto L45;
     */
    /* JADX WARN: Code restructure failed: missing block: B:6:0x0013, code lost:
    
        if ((androidx.core.view.ViewCompat.getLayoutDirection(r7) == 1) != false) goto L44;
     */
    ...
    */
    ...
    public long getStartDelay(ViewGroup viewGroup, Transition transition, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        float b2 = b(viewGroup, viewX, viewY, i3, i4, round, round2, width, height) / c(viewGroup);
        long duration = transition.getDuration();
        if (duration < 0) {
            duration = 300;
        }
        return Math.round(((duration * i2) / this.f3802d) * b2);
    }
