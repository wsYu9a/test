...
public class MotionScene {
    ...
    public class AnonymousClass1 implements Interpolator {
        ...
        public AnonymousClass1(final MotionScene this$0, final Easing val$easing) {
    ...
    public Interpolator getInterpolator() {
        ...
        if (i10 == -1) {
            return new Interpolator(this) { // from class: androidx.constraintlayout.motion.widget.MotionScene.1
                ...
                public AnonymousClass1(MotionScene this, final Easing val$easing) {
                    interpolator = val$easing;
                }
    ...
    public void processTouchEvent(MotionEvent event, int currentState, MotionLayout motionLayout) {
        ...
        if (currentState != -1) {
            ...
            if (action == 2 && !this.mIgnoreTouch) {
                ...
                if ((rawX == c.f27899e && rawY == c.f27899e) || (motionEvent = this.mLastTouchDown) == null) {
                    return;
                }
