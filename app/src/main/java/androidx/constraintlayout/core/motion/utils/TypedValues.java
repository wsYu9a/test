...
public interface TypedValues {
    ...
    public interface OnSwipe {
        ...
        public static final String[] ON_TOUCH_UP_ENUM = {"autoComplete", "autoCompleteToStart", "autoCompleteToEnd", c.f26966c, "decelerate", "decelerateAndComplete", "neverCompleteToStart", "neverCompleteToEnd"};
