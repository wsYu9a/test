...
class CircleImageView extends ImageView {
    ...
    public class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int i10) {
            float f10 = i10 / 2;
            RadialGradient radialGradient = new RadialGradient(f10, f10, CircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, (float[]) null, Shader.TileMode.CLAMP);
    ...
    public CircleImageView(Context context, int i10) {
        ...
        if (elevationSupported()) {
            ...
            shapeDrawable2.getPaint().setShadowLayer(this.mShadowRadius, i12, i11, 503316480);
