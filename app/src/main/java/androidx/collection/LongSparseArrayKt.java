...
public final class LongSparseArrayKt {
    ...
    public static final <T> T getOrDefault(@k LongSparseArray<T> receiver$0, long j10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(j10, t10);
    }

    public static final <T> T getOrElse(@k LongSparseArray<T> receiver$0, long j10, @k Function0<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> int getSize(@k LongSparseArray<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.size();
    }

    public static final <T> boolean isNotEmpty(@k LongSparseArray<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return !receiver$0.isEmpty();
    }

    @k
    public static final <T> LongIterator keyIterator(@k LongSparseArray<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return new LongIterator() { // from class: androidx.collection.LongSparseArrayKt$keyIterator$1
            ...
            public LongSparseArrayKt$keyIterator$1(LongSparseArray<T> receiver$02) {
    ...
    @k
    public static final <T> LongSparseArray<T> plus(@k LongSparseArray<T> receiver$0, @k LongSparseArray<T> other) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> boolean remove(@k LongSparseArray<T> receiver$0, long j10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.remove(j10, t10);
    }

    public static final <T> void set(@k LongSparseArray<T> receiver$0, long j10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        receiver$0.put(j10, t10);
    }

    @k
    public static final <T> Iterator<T> valueIterator(@k LongSparseArray<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
