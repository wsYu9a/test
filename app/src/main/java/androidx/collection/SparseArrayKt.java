...
public final class SparseArrayKt {
    ...
    public static final <T> T getOrDefault(@k SparseArrayCompat<T> receiver$0, int i10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.get(i10, t10);
    }

    public static final <T> T getOrElse(@k SparseArrayCompat<T> receiver$0, int i10, @k Function0<? extends T> defaultValue) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> int getSize(@k SparseArrayCompat<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.size();
    }

    public static final <T> boolean isNotEmpty(@k SparseArrayCompat<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return !receiver$0.isEmpty();
    }

    @k
    public static final <T> IntIterator keyIterator(@k SparseArrayCompat<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return new IntIterator() { // from class: androidx.collection.SparseArrayKt$keyIterator$1
            ...
            public SparseArrayKt$keyIterator$1(SparseArrayCompat<T> receiver$02) {
                receiver$0 = receiver$02;
            }
    ...
    @k
    public static final <T> SparseArrayCompat<T> plus(@k SparseArrayCompat<T> receiver$0, @k SparseArrayCompat<T> other) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
    ...
    public static final <T> boolean remove(@k SparseArrayCompat<T> receiver$0, int i10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        return receiver$0.remove(i10, t10);
    }

    public static final <T> void set(@k SparseArrayCompat<T> receiver$0, int i10, T t10) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
        receiver$0.put(i10, t10);
    }

    @k
    public static final <T> Iterator<T> valueIterator(@k SparseArrayCompat<T> receiver$0) {
        Intrinsics.checkParameterIsNotNull(receiver$0, "receiver$0");
