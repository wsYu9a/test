...
public final class ci {
    ...
    /* renamed from: a */
    private static final Comparator f23746a = new a();
    ...
    public static int a(List list, List list2) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            int compare = f23746a.compare(list.get(i10), list2.get(i10));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int compare = f23746a.compare(it.next(), it2.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f23746a;
    ...
    public static void a(ByteBuffer byteBuffer, StringBuilder sb2) {
        ...
        for (int i11 = position; i11 < i10; i11++) {
            ...
            sb2.append(a(array[i11]));
        }
        if (limit != i10) {
            sb2.append(FoldedTextView.f12585y);
        }
    }

    public static String a(byte b10) {
        return Integer.toHexString((b10 | 256) & FrameMetricsAggregator.EVERY_DURATION).toUpperCase().substring(1);
    }
