...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public class AnonymousClass1 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass1(boolean z10, View view, View view2) {
            z10 = z10;
            view2 = view;
            view = view2;
        }
    ...
    public class AnonymousClass3 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass3(CircularRevealWidget circularRevealWidget, Drawable drawable) {
    ...
    public class AnonymousClass4 extends AnimatorListenerAdapter {
        ...
        public AnonymousClass4(CircularRevealWidget circularRevealWidget) {
            circularRevealWidget = circularRevealWidget;
        }
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z10) {
                ...
                animator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.transformation.FabTransformationBehavior.4
                    ...
                    public AnonymousClass4(CircularRevealWidget circularRevealWidget2) {
                ...
                float f12 = circularRevealWidget2.getRevealInfo().radius;
                Animator createCircularReveal = CircularRevealCompat.createCircularReveal(circularRevealWidget2, calculateRevealCenterX, calculateRevealCenterY, width);
            ...
            list.add(animator);
            list2.add(CircularRevealCompat.createCircularRevealListener(circularRevealWidget2));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    private void createIconFadeAnimation(View view, View view2, boolean z10, boolean z11, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofInt;
        if ((view2 instanceof CircularRevealWidget) && (view instanceof ImageView)) {
            ...
            list2.add(new AnimatorListenerAdapter() { // from class: com.google.android.material.transformation.FabTransformationBehavior.3
                ...
                public AnonymousClass3(CircularRevealWidget circularRevealWidget2, Drawable drawable2) {
                    circularRevealWidget = circularRevealWidget2;
                    drawable = drawable2;
                }
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull View view2, boolean z10, boolean z11) {
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.transformation.FabTransformationBehavior.1
            ...
            public AnonymousClass1(boolean z102, View view22, View view3) {
                z10 = z102;
                view2 = view22;
                view = view3;
            }
