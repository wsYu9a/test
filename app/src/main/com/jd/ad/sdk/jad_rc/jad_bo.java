...
public class jad_bo implements jad_na<Uri, InputStream> {
    ...
    public jad_na.jad_an<InputStream> jad_an(@NonNull Uri uri, int i10, int i11, @NonNull jad_jw jad_jwVar) {
        Uri uri2 = uri;
        if (!com.jd.ad.sdk.jad_lw.jad_bo.jad_an(i10, i11)) {
            return null;
        }
        com.jd.ad.sdk.jad_hq.jad_bo jad_boVar = new com.jd.ad.sdk.jad_hq.jad_bo(uri2);
        Context context = this.jad_an;
        return new jad_na.jad_an<>(jad_boVar, Collections.emptyList(), com.jd.ad.sdk.jad_lw.jad_cp.jad_an(context, uri2, new jad_cp.jad_an(context.getContentResolver())));
    }
