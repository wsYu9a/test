...
public class jad_f_jw implements OnImageLoadListener {
    ...
    public jad_f_jw(com.jd.ad.sdk.feed.jad_f_an jad_f_anVar, ImageView imageView, AtomicInteger atomicInteger, int i10) {
    ...
    public void onLoadFailed(int i10, String str, @Nullable Drawable drawable) {
        int i11 = this.jad_f_bo.get();
        int i12 = this.jad_f_cp;
        if (i11 < i12) {
            this.jad_f_bo.set(i12);
