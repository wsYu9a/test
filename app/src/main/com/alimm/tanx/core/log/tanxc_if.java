...
public class tanxc_if {
    ...
    static {
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(2, 8, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue(100), new ThreadFactory() { // from class: com.alimm.tanx.core.log.tanxc_if.1
            ...
            public Thread newThread(@NonNull Runnable runnable) {
                return new Thread(runnable, "CacheThreadPool-" + tanxc_if.tanxc_do());
            }
        });
    ...
    public static void tanxc_do(@NonNull Runnable runnable) {
        try {
            ...
            Log.d("CacheThreadPool", "ILog :post exception", th2);
        }
    }
    ...
    public static void tanxc_do(@NonNull final Runnable runnable, int i10) {
        if (i10 == 0) {
            ...
            tanxc_for.postDelayed(new Runnable() { // from class: com.alimm.tanx.core.log.tanxc_if.3
