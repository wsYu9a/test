...
public final class ip implements com.kwad.sdk.core.d<com.kwad.components.ad.reward.d.b> {
    ...
    private static void a2(com.kwad.components.ad.reward.d.b bVar, JSONObject jSONObject) {
        ...
        bVar.sT = jSONObject.optInt("showInteractCount");
    }
    ...
    private static JSONObject b2(com.kwad.components.ad.reward.d.b bVar, JSONObject jSONObject) {
        ...
        int i10 = bVar.sT;
        if (i10 != 0) {
            com.kwad.sdk.utils.x.putValue(jSONObject, "showInteractCount", i10);
        }
        return jSONObject;
    }
}
